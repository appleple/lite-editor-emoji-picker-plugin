 ...
 */
var Fr = Ht.exports, Kf;
function Kr() {
  return Kf || (Kf = 1, (function(Me) {
    (function(V, we) {
      Me.exports = V.document ? we(V, !0) : function(q) {
        if (!q.document)
          throw new Error("jQuery requires a window with a document");
        return we(q);
      };
    })(typeof window < "u" ? window : Fr, function(V, we) {
      var q = [], W = Object.getPrototypeOf, D = q.slice, S = q.flat ? function(e) {
        return q.flat.call(e);
      } : function(e) {
        return q.concat.apply([], e);
      }, G = q.push, P = q.indexOf, B = {}, c = B.toString, s = B.hasOwnProperty, g = s.toString, b = g.call(Object), m = {}, l = function(t) {
      ...
      function A(e, t, f) {
        f = f || E;
        var r, o, _ = f.createElement("script");
        if (_.text = e, t)
          for (r in N)
            o = t[r] || t.getAttribute && t.getAttribute(r), o && _.setAttribute(r, o);
        f.head.appendChild(_).parentNode.removeChild(_);
      }
      function j(e) {
        return e == null ? e + "" : typeof e == "object" || typeof e == "function" ? B[c.call(e)] || "object" : typeof e;
      }
      var x = "3.7.1", F = /HTML$/i, a = function(e, t) {
      ...
      a.fn = a.prototype = {
        ...
        map: function(e) {
          return this.pushStack(a.map(this, function(t, f) {
            return e.call(t, f, t);
          }));
        },
        slice: function() {
        ...
        eq: function(e) {
          var t = this.length, f = +e + (e < 0 ? t : 0);
          return this.pushStack(f >= 0 && f < t ? [this[f]] : []);
        },
        end: function() {
        ...
        var e, t, f, r, o, _, i = arguments[0] || {}, u = 1, h = arguments.length, p = !1;
        for (typeof i == "boolean" && (p = i, i = arguments[u] || {}, u++), typeof i != "object" && !l(i) && (i = {}), u === h && (i = this, u--); u < h; u++)
          if ((e = arguments[u]) != null)
            for (t in e)
              r = e[t], !(t === "__proto__" || i === r) && (p && r && (a.isPlainObject(r) || (o = Array.isArray(r))) ? (f = i[t], o && !Array.isArray(f) ? _ = [] : !o && !a.isPlainObject(f) ? _ = {} : _ = f, o = !1, i[t] = a.extend(p, _, r)) : r !== void 0 && (i[t] = r));
        return i;
      }, a.extend({
        ...
        isPlainObject: function(e) {
          var t, f;
          return !e || c.call(e) !== "[object Object]" ? !1 : (t = W(e), t ? (f = s.call(t, "constructor") && t.constructor, typeof f == "function" && g.call(f) === b) : !0);
        },
        ...
        // if not specified.
        globalEval: function(e, t, f) {
          A(e, { nonce: t && t.nonce }, f);
        },
        each: function(e, t) {
          var f, r = 0;
          if (fe(e))
            for (f = e.length; r < f && t.call(e[r], r, e[r]) !== !1; r++)
              ;
          else
            for (r in e)
        ...
        text: function(e) {
          var t, f = "", r = 0, o = e.nodeType;
          if (!o)
            for (; t = e[r++]; )
              f += a.text(t);
          return o === 1 || o === 11 ? e.textContent : o === 9 ? e.documentElement.textContent : o === 3 || o === 4 ? e.nodeValue : f;
        },
        // results is for internal usage only
        makeArray: function(e, t) {
          var f = t || [];
          return e != null && (fe(Object(e)) ? a.merge(
            f,
            typeof e == "string" ? [e] : e
          ) : G.call(f, e)), f;
        },
        inArray: function(e, t, f) {
          return t == null ? -1 : P.call(t, e, f);
        },
        isXMLDoc: function(e) {
          var t = e && e.namespaceURI, f = e && (e.ownerDocument || e).documentElement;
          return !F.test(t || f && f.nodeName || "HTML");
        },
        // Support: Android <=4.0 only, PhantomJS 1 only
        // push.apply(_, arraylike) throws on ancient WebKit
        merge: function(e, t) {
          for (var f = +t.length, r = 0, o = e.length; r < f; r++)
            e[o++] = t[r];
          return e.length = o, e;
        },
        grep: function(e, t, f) {
          for (var r, o = [], _ = 0, i = e.length, u = !f; _ < i; _++)
            r = !t(e[_], _), r !== u && o.push(e[_]);
          return o;
        },
        ...
        map: function(e, t, f) {
          var r, o, _ = 0, i = [];
          if (fe(e))
            for (r = e.length; _ < r; _++)
              o = t(e[_], _, f), o != null && i.push(o);
          else
            for (_ in e)
              o = t(e[_], _, f), o != null && i.push(o);
          return S(i);
        ...
        support: m
      }), typeof Symbol == "function" && (a.fn[Symbol.iterator] = q[Symbol.iterator]), a.each(
      ...
      function fe(e) {
        var t = !!e && "length" in e && e.length, f = j(e);
        return l(e) || w(e) ? !1 : f === "array" || t === 0 || typeof t == "number" && t > 0 && t - 1 in e;
      }
      function ee(e, t) {
        return e.nodeName && e.nodeName.toLowerCase() === t.toLowerCase();
      }
      var Ge = q.pop, v = q.sort, k = q.splice, M = "[\\x20\\t\\r\\n\\f]", Q = new RegExp(
        "^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$",
        "g"
      );
      a.contains = function(e, t) {
        var f = t && t.parentNode;
        return e === f || !!(f && f.nodeType === 1 && // Support: IE 9 - 11+
        // IE doesn't have `contains` on SVG.
        (e.contains ? e.contains(f) : e.compareDocumentPosition && e.compareDocumentPosition(f) & 16));
      };
      ...
      a.escapeSelector = function(e) {
        return (e + "").replace(ue, Be);
      };
      var ne = E, le = G;
      (function() {
        var e, t, f, r, o, _ = le, i, u, h, p, R, y = a.expando, O = 0, C = 0, J = Dt(), _e = Dt(), te = Dt(), be = Dt(), pe = function(n, d) {
          return n === d && (o = !0), 0;
        }, xe = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", Pe = "(?:\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", oe = "\\[" + M + "*(" + Pe + ")(?:" + M + // Operator (capture 2)
        "*([*^$|!~]?=)" + M + // "Attribute values must be CSS identifiers [capture 5] or strings [capture 3 or capture 4]"
        `*(?:'((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)"|(` + Pe + "))|)" + M + "*\\]", rt = ":(" + Pe + `)(?:\\((('((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|` + oe + ")*)|.*)\\)|)", ie = new RegExp(M + "+", "g"), de = new RegExp("^" + M + "*," + M + "*"), At = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), tf = new RegExp(M + "|>"), Ye = new RegExp(rt), It = new RegExp("^" + Pe + "$"), Ue = {
          ID: new RegExp("^#(" + Pe + ")"),
          CLASS: new RegExp("^\\.(" + Pe + ")"),
          TAG: new RegExp("^(" + Pe + "|[*])"),
          ATTR: new RegExp("^" + oe),
        ...
        }, Qe = /^(?:input|select|textarea|button)$/i, Xe = /^h\d$/i, Ne = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ff = /[+~]/, ze = new RegExp("\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\([^\\r\\n\\f])", "g"), Ve = function(n, d) {
          var T = "0x" + n.slice(1) - 65536;
          return d || (T < 0 ? String.fromCharCode(T + 65536) : String.fromCharCode(T >> 10 | 55296, T & 1023 | 56320));
        }, Gr = function() {
          Je();
        }, Br = Gt(
          function(n) {
            return n.disabled === !0 && ee(n, "fieldset");
          },
        ...
        try {
          _.apply(
            q = D.call(ne.childNodes),
            ne.childNodes
          ), q[ne.childNodes.length].nodeType;
        } catch {
          _ = {
            apply: function(d, T) {
              le.apply(d, D.call(T));
            ...
            call: function(d) {
              le.apply(d, D.call(arguments, 1));
            }
          };
        }
        function se(n, d, T, I) {
          var L, H, Y, K, U, re, X, Z = d && d.ownerDocument, ae = d ? d.nodeType : 9;
          if (T = T || [], typeof n != "string" || !n || ae !== 1 && ae !== 9 && ae !== 11)
            return T;
          if (!I && (Je(d), d = d || i, h)) {
            if (ae !== 11 && (U = Ne.exec(n)))
              if (L = U[1]) {
                if (ae === 9)
                  if (Y = d.getElementById(L)) {
                    if (Y.id === L)
                      return _.call(T, Y), T;
                  } else
                    return T;
                else if (Z && (Y = Z.getElementById(L)) && se.contains(d, Y) && Y.id === L)
                  return _.call(T, Y), T;
              } else {
                if (U[2])
                  return _.apply(T, d.getElementsByTagName(n)), T;
                if ((L = U[3]) && d.getElementsByClassName)
                  return _.apply(T, d.getElementsByClassName(L)), T;
              }
            if (!be[n + " "] && (!p || !p.test(n))) {
              if (X = n, Z = d, ae === 1 && (tf.test(n) || At.test(n))) {
                for (Z = ff.test(n) && rf(d.parentNode) || d, (Z != d || !m.scope) && ((K = d.getAttribute("id")) ? K = a.escapeSelector(K) : d.setAttribute("id", K = y)), re = Rt(n), H = re.length; H--; )
                  re[H] = (K ? "#" + K : ":scope") + " " + Mt(re[H]);
                X = re.join(",");
              }
              try {
                return _.apply(
                ...
                K === y && d.removeAttribute("id");
              }
            }
          }
          return Ff(n.replace(Q, "$1"), d, T, I);
        }
        function Dt() {
          var n = [];
          function d(T, I) {
            return n.push(T + " ") > t.cacheLength && delete d[n.shift()], d[T + " "] = I;
          }
          return d;
        }
        function De(n) {
        ...
        function gt(n) {
          var d = i.createElement("fieldset");
          try {
            return !!n(d);
          } catch {
            return !1;
        ...
        function xr(n) {
          return function(d) {
            return ee(d, "input") && d.type === n;
          };
        }
        function Pr(n) {
          return function(d) {
            return (ee(d, "input") || ee(d, "button")) && d.type === n;
          };
        }
        function Uf(n) {
          return function(d) {
            return "form" in d ? d.parentNode && d.disabled === !1 ? "label" in d ? "label" in d.parentNode ? d.parentNode.disabled === n : d.disabled === n : d.isDisabled === n || // Where there is no isDisabled, check manually
            d.isDisabled !== !n && Br(d) === n : d.disabled === n : "label" in d ? d.disabled === n : !1;
          };
        }
        function at(n) {
          return De(function(d) {
            return d = +d, De(function(T, I) {
              for (var L, H = n([], T.length, d), Y = H.length; Y--; )
                T[L = H[Y]] && (T[L] = !(I[L] = T[L]));
            });
          });
        }
        ...
        function Je(n) {
          var d, T = n ? n.ownerDocument || n : ne;
          return T == i || T.nodeType !== 9 || !T.documentElement || (i = T, u = i.documentElement, h = !a.isXMLDoc(i), R = u.matches || u.webkitMatchesSelector || u.msMatchesSelector, u.msMatchesSelector && // Support: IE 11+, Edge 17 - 18+
          // IE/Edge sometimes throw a "Permission denied" error when strict-comparing
          // two documents; shallow comparisons work.
          // eslint-disable-next-line eqeqeq
          ne != i && (d = i.defaultView) && d.top !== d && d.addEventListener("unload", Gr), m.getById = gt(function(I) {
            return u.appendChild(I).id = a.expando, !i.getElementsByName || !i.getElementsByName(a.expando).length;
          }), m.disconnectedMatch = gt(function(I) {
            return R.call(I, "*");
          }), m.scope = gt(function() {
            return i.querySelectorAll(":scope");
          }), m.cssHas = gt(function() {
            try {
              return i.querySelector(":has(*,:jqfake)"), !1;
            } catch {
              return !0;
            }
          }), m.getById ? (t.filter.ID = function(I) {
            var L = I.replace(ze, Ve);
            return function(H) {
              return H.getAttribute("id") === L;
            };
          }, t.find.ID = function(I, L) {
            if (typeof L.getElementById < "u" && h) {
              var H = L.getElementById(I);
              return H ? [H] : [];
            }
          }) : (t.filter.ID = function(I) {
            var L = I.replace(ze, Ve);
            return function(H) {
              var Y = typeof H.getAttributeNode < "u" && H.getAttributeNode("id");
              return Y && Y.value === L;
            };
          }, t.find.ID = function(I, L) {
            if (typeof L.getElementById < "u" && h) {
              var H, Y, K, U = L.getElementById(I);
              if (U) {
                if (H = U.getAttributeNode("id"), H && H.value === I)
                  return [U];
                for (K = L.getElementsByName(I), Y = 0; U = K[Y++]; )
                  if (H = U.getAttributeNode("id"), H && H.value === I)
                    return [U];
              }
              return [];
            }
          }), t.find.TAG = function(I, L) {
            return typeof L.getElementsByTagName < "u" ? L.getElementsByTagName(I) : L.querySelectorAll(I);
          }, t.find.CLASS = function(I, L) {
            if (typeof L.getElementsByClassName < "u" && h)
              return L.getElementsByClassName(I);
          }, p = [], gt(function(I) {
            var L;
            u.appendChild(I).innerHTML = "<a id='" + y + "' href='' disabled='disabled'></a><select id='" + y + "-\r\\' disabled='disabled'><option selected=''></option></select>", I.querySelectorAll("[selected]").length || p.push("\\[" + M + "*(?:value|" + xe + ")"), I.querySelectorAll("[id~=" + y + "-]").length || p.push("~="), I.querySelectorAll("a#" + y + "+*").length || p.push(".#.+[+~]"), I.querySelectorAll(":checked").length || p.push(":checked"), L = i.createElement("input"), L.setAttribute("type", "hidden"), I.appendChild(L).setAttribute("name", "D"), u.appendChild(I).disabled = !0, I.querySelectorAll(":disabled").length !== 2 && p.push(":enabled", ":disabled"), L = i.createElement("input"), L.setAttribute("name", ""), I.appendChild(L), I.querySelectorAll("[name='']").length || p.push("\\[" + M + "*name" + M + "*=" + M + `*(?:''|"")`);
          }), m.cssHas || p.push(":has"), p = p.length && new RegExp(p.join("|")), pe = function(I, L) {
            if (I === L)
              return o = !0, 0;
            var H = !I.compareDocumentPosition - !L.compareDocumentPosition;
            return H || (H = (I.ownerDocument || I) == (L.ownerDocument || L) ? I.compareDocumentPosition(L) : (
              // Otherwise we know they are disconnected
              1
            ), H & 1 || !m.sortDetached && L.compareDocumentPosition(I) === H ? I === i || I.ownerDocument == ne && se.contains(ne, I) ? -1 : L === i || L.ownerDocument == ne && se.contains(ne, L) ? 1 : r ? P.call(r, I) - P.call(r, L) : 0 : H & 4 ? -1 : 1);
          }), i;
        }
        se.matches = function(n, d) {
          return se(n, null, null, d);
        }, se.matchesSelector = function(n, d) {
          if (Je(n), h && !be[d + " "] && (!p || !p.test(d)))
            try {
              var T = R.call(n, d);
              if (T || m.disconnectedMatch || // As well, disconnected nodes are said to be in a document
              // fragment in IE 9
          ...
          return se(d, i, null, [n]).length > 0;
        }, se.contains = function(n, d) {
          return (n.ownerDocument || n) != i && Je(n), a.contains(n, d);
        }, se.attr = function(n, d) {
          (n.ownerDocument || n) != i && Je(n);
          var T = t.attrHandle[d.toLowerCase()], I = T && s.call(t.attrHandle, d.toLowerCase()) ? T(n, d, !h) : void 0;
          return I !== void 0 ? I : n.getAttribute(d);
        }, se.error = function(n) {
          throw new Error("Syntax error, unrecognized expression: " + n);
        }, a.uniqueSort = function(n) {
          var d, T = [], I = 0, L = 0;
          if (o = !m.sortStable, r = !m.sortStable && D.call(n, 0), v.call(n, pe), o) {
            for (; d = n[L++]; )
              d === n[L] && (I = T.push(L));
            for (; I--; )
              k.call(n, T[I], 1);
          ...
          return this.pushStack(a.uniqueSort(D.apply(this)));
        }, t = a.expr = {
          ...
          preFilter: {
            ATTR: function(n) {
              return n[1] = n[1].replace(ze, Ve), n[3] = (n[3] || n[4] || n[5] || "").replace(ze, Ve), n[2] === "~=" && (n[3] = " " + n[3] + " "), n.slice(0, 4);
            },
            CHILD: function(n) {
            ...
            PSEUDO: function(n) {
              var d, T = !n[6] && n[2];
              return Ue.CHILD.test(n[0]) ? null : (n[3] ? n[2] = n[4] || n[5] || "" : T && Ye.test(T) && // Get excess from tokenize (recursively)
              (d = Rt(T, !0)) && // advance to the next closing parenthesis
              (d = T.indexOf(")", T.length - d) - T.length) && (n[0] = n[0].slice(0, d), n[2] = T.slice(0, d)), n.slice(0, 3));
            }
          },
          filter: {
            TAG: function(n) {
              var d = n.replace(ze, Ve).toLowerCase();
              return n === "*" ? function() {
                return !0;
              } : function(T) {
                return ee(T, d);
            ...
            CLASS: function(n) {
              var d = J[n + " "];
              return d || (d = new RegExp("(^|" + M + ")" + n + "(" + M + "|$)")) && J(n, function(T) {
                return d.test(
            ...
            ATTR: function(n, d, T) {
              return function(I) {
                var L = se.attr(I, n);
                return L == null ? d === "!=" : d ? (L += "", d === "=" ? L === T : d === "!=" ? L !== T : d === "^=" ? T && L.indexOf(T) === 0 : d === "*=" ? T && L.indexOf(T) > -1 : d === "$=" ? T && L.slice(-T.length) === T : d === "~=" ? (" " + L.replace(ie, " ") + " ").indexOf(T) > -1 : d === "|=" ? L === T || L.slice(0, T.length + 1) === T + "-" : !1) : !0;
              };
            },
            CHILD: function(n, d, T, I, L) {
              var H = n.slice(0, 3) !== "nth", Y = n.slice(-4) !== "last", K = d === "of-type";
              return I === 1 && L === 0 ? (
                // Shortcut for :nth-*(n)
                function(U) {
                  return !!U.parentNode;
                ...
                var Z, ae, $, ge, je, Te = H !== Y ? "nextSibling" : "previousSibling", Ce = U.parentNode, We = K && U.nodeName.toLowerCase(), ut = !X && !K, Oe = !1;
                if (Ce) {
                  if (H) {
                    for (; Te; ) {
                      for ($ = U; $ = $[Te]; )
                        if (K ? ee($, We) : $.nodeType === 1)
                          return !1;
                      je = Te = n === "only" && !je && "nextSibling";
                    }
                    return !0;
                  }
                  if (je = [Y ? Ce.firstChild : Ce.lastChild], Y && ut) {
                    for (ae = Ce[y] || (Ce[y] = {}), Z = ae[n] || [], ge = Z[0] === O && Z[1], Oe = ge && Z[2], $ = ge && Ce.childNodes[ge]; $ = ++ge && $ && $[Te] || // Fallback to seeking `elem` from the start
                    (Oe = ge = 0) || je.pop(); )
                      if ($.nodeType === 1 && ++Oe && $ === U) {
                        ae[n] = [O, ge, Oe];
                        break;
                      }
                  } else if (ut && (ae = U[y] || (U[y] = {}), Z = ae[n] || [], ge = Z[0] === O && Z[1], Oe = ge), Oe === !1)
                    for (; ($ = ++ge && $ && $[Te] || (Oe = ge = 0) || je.pop()) && !((K ? ee($, We) : $.nodeType === 1) && ++Oe && (ut && (ae = $[y] || ($[y] = {}), ae[n] = [O, Oe]), $ === U)); )
                      ;
                  return Oe -= L, Oe === I || Oe % I === 0 && Oe / I >= 0;
                }
              };
            },
            PSEUDO: function(n, d) {
              var T, I = t.pseudos[n] || t.setFilters[n.toLowerCase()] || se.error("unsupported pseudo: " + n);
              return I[y] ? I(d) : I.length > 1 ? (T = [n, n, "", d], t.setFilters.hasOwnProperty(n.toLowerCase()) ? De(function(L, H) {
                for (var Y, K = I(L, d), U = K.length; U--; )
                  Y = P.call(L, K[U]), L[Y] = !(H[Y] = K[U]);
              }) : function(L) {
                return I(L, 0, T);
              }) : I;
            }
          ...
          pseudos: {
            ...
            not: De(function(n) {
              var d = [], T = [], I = sf(n.replace(Q, "$1"));
              return I[y] ? De(function(L, H, Y, K) {
                for (var U, re = I(L, null, K, []), X = L.length; X--; )
                  (U = re[X]) && (L[X] = !(H[X] = U));
              }) : function(L, H, Y) {
                return d[0] = L, I(d, null, Y, T), d[0] = null, !T.pop();
              };
            }),
            has: De(function(n) {
              return function(d) {
                return se(n, d).length > 0;
              };
            }),
            contains: De(function(n) {
              return n = n.replace(ze, Ve), function(d) {
                return (d.textContent || a.text(d)).indexOf(n) > -1;
              };
            }),
            ...
            lang: De(function(n) {
              return It.test(n || "") || se.error("unsupported lang: " + n), n = n.replace(ze, Ve).toLowerCase(), function(d) {
                var T;
                do
                  if (T = h ? d.lang : d.getAttribute("xml:lang") || d.getAttribute("lang"))
                    return T = T.toLowerCase(), T === n || T.indexOf(n + "-") === 0;
            ...
            // Miscellaneous
            target: function(n) {
              var d = V.location && V.location.hash;
              return d && d.slice(1) === n.id;
            },
            root: function(n) {
              return n === u;
            },
            focus: function(n) {
              return n === Hr() && i.hasFocus() && !!(n.type || n.href || ~n.tabIndex);
            },
            // Boolean properties
            enabled: Uf(!1),
            disabled: Uf(!0),
            checked: function(n) {
              return ee(n, "input") && !!n.checked || ee(n, "option") && !!n.selected;
            },
            selected: function(n) {
            ...
            // Element/input types
            header: function(n) {
              return Xe.test(n.nodeName);
            },
            input: function(n) {
              return Qe.test(n.nodeName);
            },
            button: function(n) {
              return ee(n, "input") && n.type === "button" || ee(n, "button");
            },
            text: function(n) {
              var d;
              return ee(n, "input") && n.type === "text" && // Support: IE <10 only
              // New HTML5 attribute values (e.g., "search") appear
              // with elem.type === "text"
              ((d = n.getAttribute("type")) == null || d.toLowerCase() === "text");
            },
            // Position-in-collection
            first: at(function() {
              return [0];
            }),
            last: at(function(n, d) {
              return [d - 1];
            }),
            eq: at(function(n, d, T) {
              return [T < 0 ? T + d : T];
            }),
            even: at(function(n, d) {
              for (var T = 0; T < d; T += 2)
                n.push(T);
              return n;
            }),
            ...
            lt: at(function(n, d, T) {
              var I;
              for (T < 0 ? I = T + d : T > d ? I = d : I = T; --I >= 0; )
                n.push(I);
              return n;
            }),
            gt: at(function(n, d, T) {
              for (var I = T < 0 ? T + d : T; ++I < d; )
                n.push(I);
              return n;
            })
          }
        ...
        Wf.prototype = t.filters = t.pseudos, t.setFilters = new Wf();
        function Rt(n, d) {
          var T, I, L, H, Y, K, U, re = _e[n + " "];
          if (re)
            return d ? 0 : re.slice(0);
          for (Y = n, K = [], U = t.preFilter; Y; ) {
            (!T || (I = de.exec(Y))) && (I && (Y = Y.slice(I[0].length) || Y), K.push(L = [])), T = !1, (I = At.exec(Y)) && (T = I.shift(), L.push({
              value: T,
              // Cast descendant combinators to space
              type: I[0].replace(Q, " ")
            }), Y = Y.slice(T.length));
            for (H in t.filter)
              (I = Ue[H].exec(Y)) && (!U[H] || (I = U[H](I))) && (T = I.shift(), L.push({
                value: T,
                type: H,
                matches: I
              }), Y = Y.slice(T.length));
          ...
          return d ? Y.length : Y ? se.error(n) : (
            // Cache the tokens
            _e(n, K).slice(0)
          );
        }
        function Mt(n) {
          for (var d = 0, T = n.length, I = ""; d < T; d++)
            I += n[d].value;
          return I;
        }
        function Gt(n, d, T) {
          var I = d.dir, L = d.next, H = L || I, Y = T && H === "parentNode", K = C++;
          return d.first ? (
            ...
            function(U, re, X) {
              ...
              if (X) {
                for (; U = U[I]; )
                  if ((U.nodeType === 1 || Y) && n(U, re, X))
                    return !0;
              } else
                for (; U = U[I]; )
                  if (U.nodeType === 1 || Y)
                    if (ae = U[y] || (U[y] = {}), L && ee(U, L))
                      U = U[I] || U;
                    else {
                      if ((Z = ae[H]) && Z[0] === O && Z[1] === K)
                        return $[2] = Z[2];
                      if (ae[H] = $, $[2] = n(U, re, X))
                        return !0;
                    }
        ...
        function af(n) {
          return n.length > 1 ? function(d, T, I) {
        ...
        function Bt(n, d, T, I, L) {
          for (var H, Y = [], K = 0, U = n.length, re = d != null; K < U; K++)
            (H = n[K]) && (!T || T(H, I, L)) && (Y.push(H), re && d.push(K));
          return Y;
        }
        function of(n, d, T, I, L, H) {
          return I && !I[y] && (I = of(I)), L && !L[y] && (L = of(L, H)), De(function(Y, K, U, re) {
            var X, Z, ae, $, ge = [], je = [], Te = K.length, Ce = Y || Yr(
              d || "*",
              U.nodeType ? [U] : U,
              []
            ), We = n && (Y || !d) ? Bt(Ce, ge, n, U, re) : Ce;
            if (T ? ($ = L || (Y ? n : Te || I) ? (
              ...
              for (X = Bt($, je), I(X, [], U, re), Z = X.length; Z--; )
                (ae = X[Z]) && ($[je[Z]] = !(We[je[Z]] = ae));
            if (Y) {
              if (L || n) {
                if (L) {
                  for (X = [], Z = $.length; Z--; )
                ...
                for (Z = $.length; Z--; )
                  (ae = $[Z]) && (X = L ? P.call(Y, ae) : ge[Z]) > -1 && (Y[X] = !(K[X] = ae));
              }
            } else
              $ = Bt(
                $ === K ? $.splice(Te, $.length) : $
              ), L ? L(null, K, $, re) : _.apply(K, $);
          });
        }
        function _f(n) {
          for (var d, T, I, L = n.length, H = t.relative[n[0].type], Y = H || t.relative[" "], K = H ? 1 : 0, U = Gt(function(Z) {
            return Z === d;
          }, Y, !0), re = Gt(function(Z) {
            return P.call(d, Z) > -1;
          }, Y, !0), X = [function(Z, ae, $) {
            var ge = !H && ($ || ae != f) || ((d = ae).nodeType ? U(Z, ae, $) : re(Z, ae, $));
            return d = null, ge;
          }]; K < L; K++)
            if (T = t.relative[n[K].type])
              X = [Gt(af(X), T)];
            else {
              if (T = t.filter[n[K].type].apply(null, n[K].matches), T[y]) {
                for (I = ++K; I < L && !t.relative[n[I].type]; I++)
                  ;
                return of(
                  K > 1 && af(X),
                  K > 1 && Mt(
                    // If the preceding token was a descendant combinator, insert an implicit any-element `*`
                    n.slice(0, K - 1).concat({ value: n[K - 2].type === " " ? "*" : "" })
                  ).replace(Q, "$1"),
                  T,
                  K < I && _f(n.slice(K, I)),
                  I < L && _f(n = n.slice(I)),
        ...
        function Ur(n, d) {
          var T = d.length > 0, I = n.length > 0, L = function(H, Y, K, U, re) {
            var X, Z, ae, $ = 0, ge = "0", je = H && [], Te = [], Ce = f, We = H || I && t.find.TAG("*", re), ut = O += Ce == null ? 1 : Math.random() || 0.1, Oe = We.length;
            for (re && (f = Y == i || Y || re); ge !== Oe && (X = We[ge]) != null; ge++) {
              if (I && X) {
                for (Z = 0, !Y && X.ownerDocument != i && (Je(X), K = !h); ae = n[Z++]; )
                  if (ae(X, Y || i, K)) {
                    _.call(U, X);
                    break;
                  }
            ...
            if ($ += ge, T && ge !== $) {
              ...
              if (H) {
                if ($ > 0)
                  for (; ge--; )
                    je[ge] || Te[ge] || (Te[ge] = Ge.call(U));
                Te = Bt(Te);
              }
              _.apply(U, Te), re && !H && Te.length > 0 && $ + d.length > 1 && a.uniqueSort(U);
            }
            return re && (O = ut, f = Ce), je;
          };
          return T ? De(L) : L;
        }
        function sf(n, d) {
          var T, I = [], L = [], H = te[n + " "];
          if (!H) {
            for (d || (d = Rt(n)), T = d.length; T--; )
              H = _f(d[T]), H[y] ? I.push(H) : L.push(H);
            H = te(
              n,
              Ur(L, I)
            ), H.selector = n;
        ...
        function Ff(n, d, T, I) {
          var L, H, Y, K, U, re = typeof n == "function" && n, X = !I && Rt(n = re.selector || n);
          if (T = T || [], X.length === 1) {
            if (H = X[0] = X[0].slice(0), H.length > 2 && (Y = H[0]).type === "ID" && d.nodeType === 9 && h && t.relative[H[1].type]) {
              if (d = (t.find.ID(
                Y.matches[0].replace(ze, Ve),
                d
              ) || [])[0], d)
                re && (d = d.parentNode);
              else return T;
              n = n.slice(H.shift().value.length);
            }
            for (L = Ue.needsContext.test(n) ? 0 : H.length; L-- && (Y = H[L], !t.relative[K = Y.type]); )
              if ((U = t.find[K]) && (I = U(
                Y.matches[0].replace(ze, Ve),
                ff.test(H[0].type) && rf(d.parentNode) || d
              ))) {
                if (H.splice(L, 1), n = I.length && Mt(H), !n)
                  return _.apply(T, I), T;
                break;
              }
          }
          return (re || sf(n, X))(
            ...
            !h,
            T,
            !d || ff.test(n) && rf(d.parentNode) || d
          ), T;
        }
        m.sortStable = y.split("").sort(pe).join("") === y, Je(), m.sortDetached = gt(function(n) {
          return n.compareDocumentPosition(i.createElement("fieldset")) & 1;
        }), a.find = se, a.expr[":"] = a.expr.pseudos, a.unique = a.uniqueSort, se.compile = sf, se.select = Ff, se.setDocument = Je, se.tokenize = Rt, se.escape = a.escapeSelector, se.getText = a.text, se.isXML = a.isXMLDoc, se.selectors = a.expr, se.support = a.support, se.uniqueSort = a.uniqueSort;
      })();
      var Ee = function(e, t, f) {
        for (var r = [], o = f !== void 0; (e = e[t]) && e.nodeType !== 9; )
          if (e.nodeType === 1) {
            if (o && a(e).is(f))
              break;
            r.push(e);
        ...
        for (var f = []; e; e = e.nextSibling)
          e.nodeType === 1 && e !== t && f.push(e);
        return f;
      }, Le = a.expr.match.needsContext, he = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
      function ye(e, t, f) {
        return l(t) ? a.grep(e, function(r, o) {
          return !!t.call(r, o, r) !== f;
        }) : t.nodeType ? a.grep(e, function(r) {
          return r === t !== f;
        }) : typeof t != "string" ? a.grep(e, function(r) {
          return P.call(t, r) > -1 !== f;
        }) : a.filter(t, e, f);
      }
      a.filter = function(e, t, f) {
        var r = t[0];
        return f && (e = ":not(" + e + ")"), t.length === 1 && r.nodeType === 1 ? a.find.matchesSelector(r, e) ? [r] : [] : a.find.matches(e, a.grep(t, function(o) {
          return o.nodeType === 1;
        }));
      }, a.fn.extend({
        find: function(e) {
          var t, f, r = this.length, o = this;
          if (typeof e != "string")
          ...
          for (f = this.pushStack([]), t = 0; t < r; t++)
            a.find(e, o[t], f);
          return r > 1 ? a.uniqueSort(f) : f;
        },
        filter: function(e) {
        ...
        is: function(e) {
          return !!ye(
            ...
            typeof e == "string" && Le.test(e) ? a(e) : e || [],
            !1
          ).length;
        }
      });
      var lt, jt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, xt = a.fn.init = function(e, t, f) {
        var r, o;
        if (!e)
          return this;
        if (f = f || lt, typeof e == "string")
          if (e[0] === "<" && e[e.length - 1] === ">" && e.length >= 3 ? r = [null, e, null] : r = jt.exec(e), r && (r[1] || !t))
            if (r[1]) {
              if (t = t instanceof a ? t[0] : t, a.merge(this, a.parseHTML(
                r[1],
                t && t.nodeType ? t.ownerDocument || t : E,
                !0
              )), he.test(r[1]) && a.isPlainObject(t))
                for (r in t)
                  l(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
              return this;
            } else
              return o = E.getElementById(r[2]), o && (this[0] = o, this.length = 1), this;
          else return !t || t.jquery ? (t || f).find(e) : this.constructor(t).find(e);
        else {
          if (e.nodeType)
            return this[0] = e, this.length = 1, this;
          if (l(e))
            return f.ready !== void 0 ? f.ready(e) : (
      ...
      xt.prototype = a.fn, lt = a(E);
      var Ze = /^(?:parents|prev(?:Until|All))/, ot = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
      ...
      a.fn.extend({
        has: function(e) {
          var t = a(e, this), f = t.length;
          return this.filter(function() {
            for (var r = 0; r < f; r++)
              if (a.contains(this, t[r]))
                return !0;
          });
        },
        closest: function(e, t) {
          var f, r = 0, o = this.length, _ = [], i = typeof e != "string" && a(e);
          if (!Le.test(e)) {
            for (; r < o; r++)
              for (f = this[r]; f && f !== t; f = f.parentNode)
                if (f.nodeType < 11 && (i ? i.index(f) > -1 : (
                  // Don't pass non-elements to jQuery#find
                  f.nodeType === 1 && a.find.matchesSelector(f, e)
                ))) {
                  _.push(f);
                  break;
                }
          }
          return this.pushStack(_.length > 1 ? a.uniqueSort(_) : _);
        },
        // Determine the position of an element within the set
        index: function(e) {
          return e ? typeof e == "string" ? P.call(a(e), this[0]) : P.call(
            this,
      ...
      a.each({
        ...
        parentsUntil: function(e, t, f) {
          return Ee(e, "parentNode", f);
        },
        next: function(e) {
        ...
        nextUntil: function(e, t, f) {
          return Ee(e, "nextSibling", f);
        },
        prevUntil: function(e, t, f) {
          return Ee(e, "previousSibling", f);
        },
        siblings: function(e) {
        ...
        contents: function(e) {
          ...
          W(e.contentDocument) ? e.contentDocument : (ee(e, "template") && (e = e.content || e), a.merge([], e.childNodes));
        }
      }, function(e, t) {
        a.fn[e] = function(f, r) {
          var o = a.map(this, t, f);
          return e.slice(-5) !== "Until" && (r = f), r && typeof r == "string" && (o = a.filter(r, o)), this.length > 1 && (ot[e] || a.uniqueSort(o), Ze.test(e) && o.reverse()), this.pushStack(o);
        };
      });
      var ce = /[^\x20\t\r\n\f]+/g;
      function $e(e) {
        var t = {};
        return a.each(e.match(ce) || [], function(f, r) {
          t[r] = !0;
        }), t;
      }
      a.Callbacks = function(e) {
        e = typeof e == "string" ? $e(e) : a.extend({}, e);
        var t, f, r, o, _ = [], i = [], u = -1, h = function() {
          for (o = o || e.once, r = t = !0; i.length; u = -1)
            for (f = i.shift(); ++u < _.length; )
              _[u].apply(f[0], f[1]) === !1 && e.stopOnFalse && (u = _.length, f = !1);
          e.memory || (f = !1), t = !1, o && (f ? _ = [] : _ = "");
        }, p = {
          // Add a callback or a collection of callbacks to the list
          add: function() {
            return _ && (f && !t && (u = _.length - 1, i.push(f)), (function R(y) {
              a.each(y, function(O, C) {
                l(C) ? (!e.unique || !p.has(C)) && _.push(C) : C && C.length && j(C) !== "string" && R(C);
              });
            })(arguments), f && !t && h()), this;
          },
          // Remove a callback from the list
          remove: function() {
            return a.each(arguments, function(R, y) {
              for (var O; (O = a.inArray(y, _, O)) > -1; )
                _.splice(O, 1), O <= u && u--;
            }), this;
          },
          ...
          has: function(R) {
            return R ? a.inArray(R, _) > -1 : _.length > 0;
          },
          ...
          lock: function() {
            return o = i = [], !f && !t && (_ = f = ""), this;
          },
          locked: function() {
            return !!o;
          },
          // Call all callbacks with the given context and arguments
          fireWith: function(R, y) {
            return o || (y = y || [], y = [R, y.slice ? y.slice() : y], i.push(y), t || h()), this;
          },
      ...
      function mf(e, t, f, r) {
        var o;
        try {
          e && l(o = e.promise) ? o.call(e).done(t).fail(f) : e && l(o = e.then) ? o.call(e, t, f) : t.apply(void 0, [e].slice(r));
        } catch (_) {
          f.apply(void 0, [_]);
        }
      }
      a.extend({
          ...
          var t = [
            ...
            pipe: function() {
              ...
              return a.Deferred(function(i) {
                a.each(t, function(u, h) {
                  var p = l(_[h[4]]) && _[h[4]];
                  o[h[1]](function() {
                    var R = p && p.apply(this, arguments);
                    R && l(R.promise) ? R.promise().progress(i.notify).done(i.resolve).fail(i.reject) : i[h[0] + "With"](
                      this,
                      p ? [R] : arguments
                    );
                  });
            ...
            then: function(_, i, u) {
              ...
              function p(R, y, O, C) {
                return function() {
                  var J = this, _e = arguments, te = function() {
                    var pe, xe;
                    if (!(R < h)) {
                      if (pe = O.apply(J, _e), pe === y.promise())
                        throw new TypeError("Thenable self-resolution");
                      xe = pe && // Support: Promises/A+ section 2.3.4
                      // https://promisesaplus.com/#point-64
                      // Only check objects and functions for thenability
                      (typeof pe == "object" || typeof pe == "function") && pe.then, l(xe) ? C ? xe.call(
                        pe,
                        p(h, y, Se, C),
                        p(h, y, Lt, C)
                      ) : (h++, xe.call(
                      ...
                      )) : (O !== Se && (J = void 0, _e = [pe]), (C || y.resolveWith)(J, _e));
                    }
                  }, be = C ? te : function() {
                    try {
                      te();
                      ...
                      a.Deferred.exceptionHook && a.Deferred.exceptionHook(
                        pe,
                        be.error
                      ), R + 1 >= h && (O !== Lt && (J = void 0, _e = [pe]), y.rejectWith(J, _e));
                    }
                  };
                  R ? be() : (a.Deferred.getErrorHook ? be.error = a.Deferred.getErrorHook() : a.Deferred.getStackHook && (be.error = a.Deferred.getStackHook()), V.setTimeout(be));
                };
              }
            ...
            promise: function(_) {
              return _ != null ? a.extend(_, r) : r;
            }
          }, o = {};
          return a.each(t, function(_, i) {
            var u = i[2], h = i[5];
            r[i[1]] = u.add, h && u.add(
              function() {
                f = h;
        ...
        // Deferred helper
        when: function(e) {
          var t = arguments.length, f = t, r = Array(f), o = D.call(arguments), _ = a.Deferred(), i = function(u) {
            return function(h) {
              r[u] = this, o[u] = arguments.length > 1 ? D.call(arguments) : h, --t || _.resolveWith(r, o);
            };
          };
          if (t <= 1 && (mf(
            e,
            ...
            _.reject,
            !t
          ), _.state() === "pending" || l(o[f] && o[f].then)))
            return _.then();
          for (; f--; )
            mf(o[f], i(f), _.reject);
          return _.promise();
      ...
      var zf = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;
      a.Deferred.exceptionHook = function(e, t) {
        V.console && V.console.warn && e && zf.test(e.name) && V.console.warn(
      ...
      a.fn.ready = function(e) {
        ...
        ready: function(e) {
          (e === !0 ? --a.readyWait : a.isReady) || (a.isReady = !0, !(e !== !0 && --a.readyWait > 0) && Pt.resolveWith(E, [a]));
        }
      }), a.ready.then = Pt.then;
      function yt() {
        E.removeEventListener("DOMContentLoaded", yt), V.removeEventListener("load", yt), a.ready();
      }
      E.readyState === "complete" || E.readyState !== "loading" && !E.documentElement.doScroll ? V.setTimeout(a.ready) : (E.addEventListener("DOMContentLoaded", yt), V.addEventListener("load", yt));
      var Ke = function(e, t, f, r, o, _, i) {
        var u = 0, h = e.length, p = f == null;
        if (j(f) === "object") {
          o = !0;
          for (u in f)
            Ke(e, t, u, f[u], !0, _, i);
        } else if (r !== void 0 && (o = !0, l(r) || (i = !0), p && (i ? (t.call(e, r), t = null) : (p = t, t = function(R, y, O) {
          return p.call(a(R), O);
        })), t))
          for (; u < h; u++)
            t(
              e[u],
              f,
              i ? r : r.call(e[u], u, t(e[u], f))
            );
        return o ? e : p ? t.call(e) : h ? t(e[0], f) : _;
      }, Vf = /^-ms-/, $f = /-([a-z])/g;
      function Qf(e, t) {
        return t.toUpperCase();
      }
      function He(e) {
        return e.replace(Vf, "ms-").replace($f, Qf);
      }
      var dt = function(e) {
        return e.nodeType === 1 || e.nodeType === 9 || !+e.nodeType;
      };
      function ct() {
        this.expando = a.expando + ct.uid++;
      }
      ct.uid = 1, ct.prototype = {
        ...
        access: function(e, t, f) {
          return t === void 0 || t && typeof t == "string" && f === void 0 ? this.get(e, t) : (this.set(e, t, f), f !== void 0 ? f : t);
        },
        remove: function(e, t) {
          var f, r = e[this.expando];
          if (r !== void 0) {
            if (t !== void 0)
              for (Array.isArray(t) ? t = t.map(He) : (t = He(t), t = t in r ? [t] : t.match(ce) || []), f = t.length; f--; )
                delete r[t[f]];
            (t === void 0 || a.isEmptyObject(r)) && (e.nodeType ? e[this.expando] = void 0 : delete e[this.expando]);
          }
        },
        hasData: function(e) {
          var t = e[this.expando];
      ...
      var z = new ct(), Ae = new ct(), Xf = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Jf = /[A-Z]/g;
      function Zf(e) {
        return e === "true" ? !0 : e === "false" ? !1 : e === "null" ? null : e === +e + "" ? +e : Xf.test(e) ? JSON.parse(e) : e;
      }
      function hf(e, t, f) {
        var r;
        if (f === void 0 && e.nodeType === 1)
          if (r = "data-" + t.replace(Jf, "-$&").toLowerCase(), f = e.getAttribute(r), typeof f == "string") {
            try {
              f = Zf(f);
            } catch {
            }
      ...
      a.extend({
        hasData: function(e) {
          return Ae.hasData(e) || z.hasData(e);
        },
        data: function(e, t, f) {
          return Ae.access(e, t, f);
        },
        ...
        _data: function(e, t, f) {
          return z.access(e, t, f);
        },
        ...
        data: function(e, t) {
          var f, r, o, _ = this[0], i = _ && _.attributes;
          if (e === void 0) {
            if (this.length && (o = Ae.get(_), _.nodeType === 1 && !z.get(_, "hasDataAttrs"))) {
              for (f = i.length; f--; )
                i[f] && (r = i[f].name, r.indexOf("data-") === 0 && (r = He(r.slice(5)), hf(_, r, o[r])));
              z.set(_, "hasDataAttrs", !0);
            }
            return o;
          }
          return typeof e == "object" ? this.each(function() {
            ...
            var h;
            if (_ && u === void 0)
              return h = Ae.get(_, e), h !== void 0 || (h = hf(_, e), h !== void 0) ? h : void 0;
            this.each(function() {
              Ae.set(this, e, u);
            });
        ...
        queue: function(e, t, f) {
          var r;
          if (e)
            return t = (t || "fx") + "queue", r = z.get(e, t), f && (!r || Array.isArray(f) ? r = z.access(e, t, a.makeArray(f)) : r.push(f)), r || [];
        },
        dequeue: function(e, t) {
          t = t || "fx";
          var f = a.queue(e, t), r = f.length, o = f.shift(), _ = a._queueHooks(e, t), i = function() {
            a.dequeue(e, t);
          };
          o === "inprogress" && (o = f.shift(), r--), o && (t === "fx" && f.unshift("inprogress"), delete _.stop, o.call(e, i, _)), !r && _ && _.empty.fire();
        },
        // Not public - generate a queueHooks object, or return the current one
        _queueHooks: function(e, t) {
          var f = t + "queueHooks";
          return z.get(e, f) || z.access(e, f, {
            empty: a.Callbacks("once memory").add(function() {
              z.remove(e, [t + "queue", f]);
            })
          });
        }
      }), a.fn.extend({
        queue: function(e, t) {
          var f = 2;
          return typeof e != "string" && (t = e, e = "fx", f--), arguments.length < f ? a.queue(this[0], e) : t === void 0 ? this : this.each(function() {
            var r = a.queue(this, e, t);
            a._queueHooks(this, e), e === "fx" && r[0] !== "inprogress" && a.dequeue(this, e);
          });
        },
        dequeue: function(e) {
          return this.each(function() {
        ...
        promise: function(e, t) {
          var f, r = 1, o = a.Deferred(), _ = this, i = this.length, u = function() {
            --r || o.resolveWith(_, [_]);
          };
          for (typeof e != "string" && (t = e, e = void 0), e = e || "fx"; i--; )
            f = z.get(_[i], e + "queueHooks"), f && f.empty && (r++, f.empty.add(u));
          return u(), o.promise(t);
        }
      });
      var gf = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, pt = new RegExp("^(?:([+-])=|)(" + gf + ")([a-z%]*)$", "i"), qe = ["Top", "Right", "Bottom", "Left"], et = E.documentElement, _t = function(e) {
        return a.contains(e.ownerDocument, e);
      }, er = { composed: !0 };
      et.getRootNode && (_t = function(e) {
        return a.contains(e.ownerDocument, e) || e.getRootNode(er) === e.ownerDocument;
      });
      var St = function(e, t) {
        ...
        // in the document.
        _t(e) && a.css(e, "display") === "none";
      };
      function uf(e, t, f, r) {
        var o, _, i = 20, u = r ? function() {
          return r.cur();
        } : function() {
          return a.css(e, t, "");
        }, h = u(), p = f && f[3] || (a.cssNumber[t] ? "" : "px"), R = e.nodeType && (a.cssNumber[t] || p !== "px" && +h) && pt.exec(a.css(e, t));
        if (R && R[3] !== p) {
          for (h = h / 2, p = p || R[3], R = +h || 1; i--; )
            a.style(e, t, R + p), (1 - _) * (1 - (_ = u() / h || 0.5)) <= 0 && (i = 0), R = R / _;
          R = R * 2, a.style(e, t, R + p), f = f || [];
        }
        return f && (R = +R || +h || 0, o = f[1] ? R + (f[1] + 1) * f[2] : +f[2], r && (r.unit = p, r.start = R, r.end = o)), o;
      }
      var lf = {};
      function tr(e) {
        var t, f = e.ownerDocument, r = e.nodeName, o = lf[r];
        return o || (t = f.body.appendChild(f.createElement(r)), o = a.css(t, "display"), t.parentNode.removeChild(t), o === "none" && (o = "block"), lf[r] = o, o);
      }
      function it(e, t) {
        for (var f, r, o = [], _ = 0, i = e.length; _ < i; _++)
          r = e[_], r.style && (f = r.style.display, t ? (f === "none" && (o[_] = z.get(r, "display") || null, o[_] || (r.style.display = "")), r.style.display === "" && St(r) && (o[_] = tr(r))) : f !== "none" && (o[_] = "none", z.set(r, "display", f)));
        for (_ = 0; _ < i; _++)
          o[_] != null && (e[_].style.display = o[_]);
        return e;
      }
      a.fn.extend({
        show: function() {
      ...
      var bt = /^(?:checkbox|radio)$/i, df = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, cf = /^$|^module$|\/(?:java|ecma)script/i;
      (function() {
        var e = E.createDocumentFragment(), t = e.appendChild(E.createElement("div")), f = E.createElement("input");
        f.setAttribute("type", "radio"), f.setAttribute("checked", "checked"), f.setAttribute("name", "t"), t.appendChild(f), m.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked, t.innerHTML = "<textarea>x</textarea>", m.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue, t.innerHTML = "<option></option>", m.option = !!t.lastChild;
      })();
      var ve = {
      ...
      function Ie(e, t) {
        var f;
        return typeof e.getElementsByTagName < "u" ? f = e.getElementsByTagName(t || "*") : typeof e.querySelectorAll < "u" ? f = e.querySelectorAll(t || "*") : f = [], t === void 0 || t && ee(e, t) ? a.merge([e], f) : f;
      }
      function Yt(e, t) {
        for (var f = 0, r = e.length; f < r; f++)
          z.set(
            e[f],
            "globalEval",
            !t || z.get(t[f], "globalEval")
          );
      }
      var fr = /<|&#?\w+;/;
      function pf(e, t, f, r, o) {
        for (var _, i, u, h, p, R, y = t.createDocumentFragment(), O = [], C = 0, J = e.length; C < J; C++)
          if (_ = e[C], _ || _ === 0)
            if (j(_) === "object")
              a.merge(O, _.nodeType ? [_] : _);
            else if (!fr.test(_))
              O.push(t.createTextNode(_));
            else {
              for (i = i || y.appendChild(t.createElement("div")), u = (df.exec(_) || ["", ""])[1].toLowerCase(), h = ve[u] || ve._default, i.innerHTML = h[1] + a.htmlPrefilter(_) + h[2], R = h[0]; R--; )
                i = i.lastChild;
              a.merge(O, i.childNodes), i = y.firstChild, i.textContent = "";
            }
        for (y.textContent = "", C = 0; _ = O[C++]; ) {
          if (r && a.inArray(_, r) > -1) {
            o && o.push(_);
            continue;
          }
          if (p = _t(_), i = Ie(y.appendChild(_), "script"), p && Yt(i), f)
            for (R = 0; _ = i[R++]; )
              cf.test(_.type || "") && f.push(_);
        }
        return y;
      }
      var bf = /^([^.]*)(?:\.(.+)|)/;
      ...
      function Ut(e, t, f, r, o, _) {
        var i, u;
        if (typeof t == "object") {
          typeof f != "string" && (r = r || f, f = void 0);
          for (u in t)
            Ut(e, u, f, r, t[u], _);
          return e;
        }
        if (r == null && o == null ? (o = f, r = f = void 0) : o == null && (typeof f == "string" ? (o = r, r = void 0) : (o = r, r = f, f = void 0)), o === !1)
          o = nt;
        else if (!o)
          return e;
        return _ === 1 && (i = o, o = function(h) {
          return a().off(h), i.apply(this, arguments);
        }, o.guid = i.guid || (i.guid = a.guid++)), e.each(function() {
          a.event.add(this, t, o, r, f);
        });
      }
      a.event = {
        global: {},
        add: function(e, t, f, r, o) {
          var _, i, u, h, p, R, y, O, C, J, _e, te = z.get(e);
          if (dt(e))
            for (f.handler && (_ = f, f = _.handler, o = _.selector), o && a.find.matchesSelector(et, o), f.guid || (f.guid = a.guid++), (h = te.events) || (h = te.events = /* @__PURE__ */ Object.create(null)), (i = te.handle) || (i = te.handle = function(be) {
              return typeof a < "u" && a.event.triggered !== be.type ? a.event.dispatch.apply(e, arguments) : void 0;
            }), t = (t || "").match(ce) || [""], p = t.length; p--; )
              u = bf.exec(t[p]) || [], C = _e = u[1], J = (u[2] || "").split(".").sort(), C && (y = a.event.special[C] || {}, C = (o ? y.delegateType : y.bindType) || C, y = a.event.special[C] || {}, R = a.extend({
                type: C,
                origType: _e,
                data: r,
                handler: f,
                ...
                namespace: J.join(".")
              }, _), (O = h[C]) || (O = h[C] = [], O.delegateCount = 0, (!y.setup || y.setup.call(e, r, J, i) === !1) && e.addEventListener && e.addEventListener(C, i)), y.add && (y.add.call(e, R), R.handler.guid || (R.handler.guid = f.guid)), o ? O.splice(O.delegateCount++, 0, R) : O.push(R), a.event.global[C] = !0);
        },
        // Detach an event or set of events from an element
        remove: function(e, t, f, r, o) {
          var _, i, u, h, p, R, y, O, C, J, _e, te = z.hasData(e) && z.get(e);
          if (!(!te || !(h = te.events))) {
            for (t = (t || "").match(ce) || [""], p = t.length; p--; ) {
              if (u = bf.exec(t[p]) || [], C = _e = u[1], J = (u[2] || "").split(".").sort(), !C) {
                for (C in h)
                  a.event.remove(e, C + t[p], f, r, !0);
                continue;
              }
              for (y = a.event.special[C] || {}, C = (r ? y.delegateType : y.bindType) || C, O = h[C] || [], u = u[2] && new RegExp("(^|\\.)" + J.join("\\.(?:.*\\.|)") + "(\\.|$)"), i = _ = O.length; _--; )
                R = O[_], (o || _e === R.origType) && (!f || f.guid === R.guid) && (!u || u.test(R.namespace)) && (!r || r === R.selector || r === "**" && R.selector) && (O.splice(_, 1), R.selector && O.delegateCount--, y.remove && y.remove.call(e, R));
              i && !O.length && ((!y.teardown || y.teardown.call(e, J, te.handle) === !1) && a.removeEvent(e, C, te.handle), delete h[C]);
            }
            a.isEmptyObject(h) && z.remove(e, "handle events");
          }
        },
        dispatch: function(e) {
          var t, f, r, o, _, i, u = new Array(arguments.length), h = a.event.fix(e), p = (z.get(this, "events") || /* @__PURE__ */ Object.create(null))[h.type] || [], R = a.event.special[h.type] || {};
          for (u[0] = h, t = 1; t < arguments.length; t++)
            u[t] = arguments[t];
          if (h.delegateTarget = this, !(R.preDispatch && R.preDispatch.call(this, h) === !1)) {
            for (i = a.event.handlers.call(this, h, p), t = 0; (o = i[t++]) && !h.isPropagationStopped(); )
              for (h.currentTarget = o.elem, f = 0; (_ = o.handlers[f++]) && !h.isImmediatePropagationStopped(); )
                (!h.rnamespace || _.namespace === !1 || h.rnamespace.test(_.namespace)) && (h.handleObj = _, h.data = _.data, r = ((a.event.special[_.origType] || {}).handle || _.handler).apply(o.elem, u), r !== void 0 && (h.result = r) === !1 && (h.preventDefault(), h.stopPropagation()));
            return R.postDispatch && R.postDispatch.call(this, h), h.result;
          }
        },
        handlers: function(e, t) {
          var f, r, o, _, i, u = [], h = t.delegateCount, p = e.target;
          if (h && // Support: IE <=9
          ...
          !(e.type === "click" && e.button >= 1)) {
            for (; p !== this; p = p.parentNode || this)
              if (p.nodeType === 1 && !(e.type === "click" && p.disabled === !0)) {
                for (_ = [], i = {}, f = 0; f < h; f++)
                  r = t[f], o = r.selector + " ", i[o] === void 0 && (i[o] = r.needsContext ? a(o, this).index(p) > -1 : a.find(o, this, null, [p]).length), i[o] && _.push(r);
                _.length && u.push({ elem: p, handlers: _ });
              }
          }
          return p = this, h < t.length && u.push({ elem: p, handlers: t.slice(h) }), u;
        },
        ...
        special: {
          ...
          click: {
            ...
            setup: function(e) {
              var t = this || e;
              return bt.test(t.type) && t.click && ee(t, "input") && vt(t, "click", !0), !1;
            },
            trigger: function(e) {
              var t = this || e;
              return bt.test(t.type) && t.click && ee(t, "input") && vt(t, "click"), !0;
            },
            // For cross-browser consistency, suppress native .click() on links
            // Also prevent it if we're currently inside a leveraged native-event stack
            _default: function(e) {
              var t = e.target;
              return bt.test(t.type) && t.click && ee(t, "input") && z.get(t, "click") || ee(t, "a");
            }
          },
          beforeunload: {
      ...
      function vt(e, t, f) {
        if (!f) {
          z.get(e, t) === void 0 && a.event.add(e, t, st);
          return;
        }
        z.set(e, t, !1), a.event.add(e, t, {
          namespace: !1,
          handler: function(r) {
            var o, _ = z.get(this, t);
            if (r.isTrigger & 1 && this[t]) {
              if (_)
                (a.event.special[t] || {}).delegateType && r.stopPropagation();
              else if (_ = D.call(arguments), z.set(this, t, _), this[t](), o = z.get(this, t), z.set(this, t, !1), _ !== o)
                return r.stopImmediatePropagation(), r.preventDefault(), o;
            } else _ && (z.set(this, t, a.event.trigger(
              _[0],
              _.slice(1),
              this
      ...
      a.removeEvent = function(e, t, f) {
        e.removeEventListener && e.removeEventListener(t, f);
        ...
        e.returnValue === !1 ? st : nt, this.target = e.target && e.target.nodeType === 3 ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && a.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[a.expando] = !0;
      }, a.Event.prototype = {
        constructor: a.Event,
        ...
        function f(r) {
          if (E.documentMode) {
            var o = z.get(this, "handle"), _ = a.event.fix(r);
            _.type = r.type === "focusin" ? "focus" : "blur", _.isSimulated = !0, o(r), _.target === _.currentTarget && o(_);
          } else
            a.event.simulate(
              t,
              r.target,
        ...
        a.event.special[e] = {
          ...
          setup: function() {
            var r;
            if (vt(this, e, !0), E.documentMode)
              r = z.get(this, t), r || this.addEventListener(t, f), z.set(this, t, (r || 0) + 1);
            else
              return !1;
          },
          trigger: function() {
          ...
          teardown: function() {
            var r;
            if (E.documentMode)
              r = z.get(this, t) - 1, r ? z.set(this, t, r) : (this.removeEventListener(t, f), z.remove(this, t));
            else
              return !1;
          },
          ...
          _default: function(r) {
            return z.get(r.target, e);
          },
          delegateType: t
        }, a.event.special[t] = {
          setup: function() {
            var r = this.ownerDocument || this.document || this, o = E.documentMode ? this : r, _ = z.get(o, t);
            _ || (E.documentMode ? this.addEventListener(t, f) : r.addEventListener(e, f, !0)), z.set(o, t, (_ || 0) + 1);
          },
          teardown: function() {
            var r = this.ownerDocument || this.document || this, o = E.documentMode ? this : r, _ = z.get(o, t) - 1;
            _ ? z.set(o, t, _) : (E.documentMode ? this.removeEventListener(t, f) : r.removeEventListener(e, f, !0), z.remove(o, t));
          }
        };
      }), a.each({
        ...
        a.event.special[e] = {
          ...
          bindType: t,
          handle: function(f) {
            var r, o = this, _ = f.relatedTarget, i = f.handleObj;
            return (!_ || _ !== o && !a.contains(o, _)) && (f.type = i.origType, r = i.handler.apply(this, arguments), f.type = t), r;
          }
        };
      }), a.fn.extend({
        on: function(e, t, f, r) {
          return Ut(this, e, t, f, r);
        },
        one: function(e, t, f, r) {
          return Ut(this, e, t, f, r, 1);
        },
        off: function(e, t, f) {
          var r, o;
          if (e && e.preventDefault && e.handleObj)
            return r = e.handleObj, a(e.delegateTarget).off(
          ...
          return (t === !1 || typeof t == "function") && (f = t, t = void 0), f === !1 && (f = nt), this.each(function() {
            a.event.remove(this, e, f, t);
          });
        }
      });
      var rr = /<script|<style|<link/i, ar = /checked\s*(?:[^=]|=\s*.checked.)/i, or = /^\s*<!\[CDATA\[|\]\]>\s*$/g;
      function wf(e, t) {
        return ee(e, "table") && ee(t.nodeType !== 11 ? t : t.firstChild, "tr") && a(e).children("tbody")[0] || e;
      }
      function _r(e) {
      ...
      function Ef(e, t) {
        var f, r, o, _, i, u, h;
        if (t.nodeType === 1) {
          if (z.hasData(e) && (_ = z.get(e), h = _.events, h)) {
            z.remove(t, "handle events");
            for (o in h)
              for (f = 0, r = h[o].length; f < r; f++)
                a.event.add(t, o, h[o][f]);
          }
          Ae.hasData(e) && (i = Ae.access(e), u = a.extend({}, i), Ae.set(t, u));
        }
      }
      function sr(e, t) {
        var f = t.nodeName.toLowerCase();
        f === "input" && bt.test(e.type) ? t.checked = e.checked : (f === "input" || f === "textarea") && (t.defaultValue = e.defaultValue);
      }
      function mt(e, t, f, r) {
        t = S(t);
        var o, _, i, u, h, p, R = 0, y = e.length, O = y - 1, C = t[0], J = l(C);
        if (J || y > 1 && typeof C == "string" && !m.checkClone && ar.test(C))
          return e.each(function(_e) {
            var te = e.eq(_e);
            J && (t[0] = C.call(this, _e, te.html())), mt(te, t, f, r);
          });
        if (y && (o = pf(t, e[0].ownerDocument, !1, e, r), _ = o.firstChild, o.childNodes.length === 1 && (o = _), _ || r)) {
          for (i = a.map(Ie(o, "script"), _r), u = i.length; R < y; R++)
            h = o, R !== O && (h = a.clone(h, !0, !0), u && a.merge(i, Ie(h, "script"))), f.call(e[R], h, R);
          if (u)
            for (p = i[i.length - 1].ownerDocument, a.map(i, ir), R = 0; R < u; R++)
              h = i[R], cf.test(h.type || "") && !z.access(h, "globalEval") && a.contains(p, h) && (h.src && (h.type || "").toLowerCase() !== "module" ? a._evalUrl && !h.noModule && a._evalUrl(h.src, {
                nonce: h.nonce || h.getAttribute("nonce")
              }, p) : A(h.textContent.replace(or, ""), h, p));
        }
        return e;
      }
      function Tf(e, t, f) {
        for (var r, o = t ? a.filter(t, e) : e, _ = 0; (r = o[_]) != null; _++)
          !f && r.nodeType === 1 && a.cleanData(Ie(r)), r.parentNode && (f && _t(r) && Yt(Ie(r, "script")), r.parentNode.removeChild(r));
        return e;
      }
      a.extend({
        ...
        clone: function(e, t, f) {
          var r, o, _, i, u = e.cloneNode(!0), h = _t(e);
          if (!m.noCloneChecked && (e.nodeType === 1 || e.nodeType === 11) && !a.isXMLDoc(e))
            for (i = Ie(u), _ = Ie(e), r = 0, o = _.length; r < o; r++)
              sr(_[r], i[r]);
          if (t)
            if (f)
              for (_ = _ || Ie(e), i = i || Ie(u), r = 0, o = _.length; r < o; r++)
                Ef(_[r], i[r]);
            else
              Ef(e, u);
          return i = Ie(u, "script"), i.length > 0 && Yt(i, !h && Ie(e, "script")), u;
        },
        cleanData: function(e) {
          for (var t, f, r, o = a.event.special, _ = 0; (f = e[_]) !== void 0; _++)
            if (dt(f)) {
              if (t = f[z.expando]) {
                if (t.events)
                  for (r in t.events)
                    o[r] ? a.event.remove(f, r) : a.removeEvent(f, r, t.handle);
                f[z.expando] = void 0;
              }
              f[Ae.expando] && (f[Ae.expando] = void 0);
            }
        }
      }), a.fn.extend({
        detach: function(e) {
        ...
        empty: function() {
          for (var e, t = 0; (e = this[t]) != null; t++)
            e.nodeType === 1 && (a.cleanData(Ie(e, !1)), e.textContent = "");
          return this;
        },
        clone: function(e, t) {
        ...
        html: function(e) {
          return Ke(this, function(t) {
            var f = this[0] || {}, r = 0, o = this.length;
            if (t === void 0 && f.nodeType === 1)
              return f.innerHTML;
            if (typeof t == "string" && !rr.test(t) && !ve[(df.exec(t) || ["", ""])[1].toLowerCase()]) {
              t = a.htmlPrefilter(t);
              try {
                for (; r < o; r++)
                  f = this[r] || {}, f.nodeType === 1 && (a.cleanData(Ie(f, !1)), f.innerHTML = t);
                f = 0;
              } catch {
              }
            }
            f && this.empty().append(t);
          }, null, e, arguments.length);
        },
        replaceWith: function() {
          ...
          return mt(this, arguments, function(t) {
            ...
            a.inArray(this, e) < 0 && (a.cleanData(Ie(this)), f && f.replaceChild(t, this));
          }, e);
        }
      }), a.each({
        appendTo: "append",
        ...
        a.fn[e] = function(f) {
          for (var r, o = [], _ = a(f), i = _.length - 1, u = 0; u <= i; u++)
            r = u === i ? this : this.clone(!0), a(_[u])[t](r), G.apply(o, r.get());
          return this.pushStack(o);
        };
      });
      var Wt = new RegExp("^(" + gf + ")(?!px)[a-z%]+$", "i"), Ft = /^--/, Nt = function(e) {
        var t = e.ownerDocument.defaultView;
        return (!t || !t.opener) && (t = V), t.getComputedStyle(e);
      }, Of = function(e, t, f) {
        var r, o, _ = {};
        for (o in t)
          _[o] = e.style[o], e.style[o] = t[o];
        r = f.call(e);
        for (o in t)
          e.style[o] = _[o];
        return r;
      }, nr = new RegExp(qe.join("|"), "i");
      (function() {
        function e() {
          if (p) {
            h.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", p.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", et.appendChild(h).appendChild(p);
            var R = V.getComputedStyle(p);
            f = R.top !== "1%", u = t(R.marginLeft) === 12, p.style.right = "60%", _ = t(R.right) === 36, r = t(R.width) === 36, p.style.position = "absolute", o = t(p.offsetWidth / 3) === 12, et.removeChild(h), p = null;
          }
        }
        function t(R) {
          return Math.round(parseFloat(R));
        }
        var f, r, o, _, i, u, h = E.createElement("div"), p = E.createElement("div");
        p.style && (p.style.backgroundClip = "content-box", p.cloneNode(!0).style.backgroundClip = "", m.clearCloneStyle = p.style.backgroundClip === "content-box", a.extend(m, {
          ...
          reliableTrDimensions: function() {
            var R, y, O, C;
            return i == null && (R = E.createElement("table"), y = E.createElement("tr"), O = E.createElement("div"), R.style.cssText = "position:absolute;left:-11111px;border-collapse:separate", y.style.cssText = "box-sizing:content-box;border:1px solid", y.style.height = "1px", O.style.height = "9px", O.style.display = "block", et.appendChild(R).appendChild(y).appendChild(O), C = V.getComputedStyle(y), i = parseInt(C.height, 10) + parseInt(C.borderTopWidth, 10) + parseInt(C.borderBottomWidth, 10) === y.offsetHeight, et.removeChild(R)), i;
          }
        }));
      })();
      function wt(e, t, f) {
        var r, o, _, i, u = Ft.test(t), h = e.style;
        return f = f || Nt(e), f && (i = f.getPropertyValue(t) || f[t], u && i && (i = i.replace(Q, "$1") || void 0), i === "" && !_t(e) && (i = a.style(e, t)), !m.pixelBoxStyles() && Wt.test(i) && nr.test(t) && (r = h.width, o = h.minWidth, _ = h.maxWidth, h.minWidth = h.maxWidth = h.width = i, i = f.width, h.width = r, h.minWidth = o, h.maxWidth = _)), i !== void 0 ? (
      ...
      var If = ["Webkit", "Moz", "ms"], Rf = E.createElement("div").style, jf = {};
      function mr(e) {
        for (var t = e[0].toUpperCase() + e.slice(1), f = If.length; f--; )
          if (e = If[f] + t, e in Rf)
            return e;
      }
      function Kt(e) {
        var t = a.cssProps[e] || jf[e];
        return t || (e in Rf ? e : jf[e] = mr(e) || e);
      }
      var hr = /^(none|table(?!-c[ea]).+)/, gr = { position: "absolute", visibility: "hidden", display: "block" }, Lf = {
        letterSpacing: "0",
        fontWeight: "400"
      };
      function yf(e, t, f) {
        ...
        return r ? (
          ...
          Math.max(0, r[2] - (f || 0)) + (r[3] || "px")
        ) : t;
      }
      function qt(e, t, f, r, o, _) {
        var i = t === "width" ? 1 : 0, u = 0, h = 0, p = 0;
        if (f === (r ? "border" : "content"))
          return 0;
        for (; i < 4; i += 2)
          f === "margin" && (p += a.css(e, f + qe[i], !0, o)), r ? (f === "content" && (h -= a.css(e, "padding" + qe[i], !0, o)), f !== "margin" && (h -= a.css(e, "border" + qe[i] + "Width", !0, o))) : (h += a.css(e, "padding" + qe[i], !0, o), f !== "padding" ? h += a.css(e, "border" + qe[i] + "Width", !0, o) : u += a.css(e, "border" + qe[i] + "Width", !0, o));
        return !r && _ >= 0 && (h += Math.max(0, Math.ceil(
          e["offset" + t[0].toUpperCase() + t.slice(1)] - _ - h - u - 0.5
          // If offsetWidth/offsetHeight is unknown, then we can't determine content-box scroll gutter
          // Use an explicit zero to avoid NaN (gh-3964)
        )) || 0), h + p;
      }
      function Sf(e, t, f) {
        var r = Nt(e), o = !m.boxSizingReliable() || f, _ = o && a.css(e, "boxSizing", !1, r) === "border-box", i = _, u = wt(e, t, r), h = "offset" + t[0].toUpperCase() + t.slice(1);
        if (Wt.test(u)) {
          if (!f)
            return u;
          u = "auto";
        }
        return (!m.boxSizingReliable() && _ || // Support: IE 10 - 11+, Edge 15 - 18+
        // IE/Edge misreport `getComputedStyle` of table rows with width/height
        // set in CSS while `offset*` properties report correct values.
        ...
        !parseFloat(u) && a.css(e, "display", !1, r) === "inline") && // Make sure the element is visible & connected
        e.getClientRects().length && (_ = a.css(e, "boxSizing", !1, r) === "border-box", i = h in e, i && (u = e[h])), u = parseFloat(u) || 0, u + qt(
          e,
          t,
          f || (_ ? "border" : "content"),
          i,
      ...
      a.extend({
        ...
        style: function(e, t, f, r) {
          if (!(!e || e.nodeType === 3 || e.nodeType === 8 || !e.style)) {
            var o, _, i, u = He(t), h = Ft.test(t), p = e.style;
            if (h || (t = Kt(u)), i = a.cssHooks[t] || a.cssHooks[u], f !== void 0) {
              if (_ = typeof f, _ === "string" && (o = pt.exec(f)) && o[1] && (f = uf(e, t, o), _ = "number"), f == null || f !== f)
                return;
              _ === "number" && !h && (f += o && o[3] || (a.cssNumber[u] ? "" : "px")), !m.clearCloneStyle && f === "" && t.indexOf("background") === 0 && (p[t] = "inherit"), (!i || !("set" in i) || (f = i.set(e, f, r)) !== void 0) && (h ? p.setProperty(t, f) : p[t] = f);
            } else
              return i && "get" in i && (o = i.get(e, !1, r)) !== void 0 ? o : p[t];
          }
        },
        css: function(e, t, f, r) {
          var o, _, i, u = He(t), h = Ft.test(t);
          return h || (t = Kt(u)), i = a.cssHooks[t] || a.cssHooks[u], i && "get" in i && (o = i.get(e, !0, f)), o === void 0 && (o = wt(e, t, r)), o === "normal" && t in Lf && (o = Lf[t]), f === "" || f ? (_ = parseFloat(o), f === !0 || isFinite(_) ? _ || 0 : o) : o;
        }
      }), a.each(["height", "width"], function(e, t) {
        a.cssHooks[t] = {
          get: function(f, r, o) {
            if (r)
              return hr.test(a.css(f, "display")) && // Support: Safari 8+
              // Table columns in Safari have non-zero offsetWidth & zero
              // getBoundingClientRect().width unless display is changed.
              // Support: IE <=11 only
              // Running getBoundingClientRect on a disconnected node
              // in IE throws an error.
              (!f.getClientRects().length || !f.getBoundingClientRect().width) ? Of(f, gr, function() {
                return Sf(f, t, o);
              }) : Sf(f, t, o);
          },
          set: function(f, r, o) {
            var _, i = Nt(f), u = !m.scrollboxSize() && i.position === "absolute", h = u || o, p = h && a.css(f, "boxSizing", !1, i) === "border-box", R = o ? qt(
              f,
              t,
              o,
              p,
            ...
            return p && u && (R -= Math.ceil(
              f["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(i[t]) - qt(f, t, "border", !1, i) - 0.5
            )), R && (_ = pt.exec(r)) && (_[3] || "px") !== "px" && (f.style[t] = r, r = a.css(f, t)), yf(f, r, R);
          }
        };
      }), a.cssHooks.marginLeft = Af(
        m.reliableMarginLeft,
        function(e, t) {
          if (t)
            return (parseFloat(wt(e, "marginLeft")) || e.getBoundingClientRect().left - Of(e, { marginLeft: 0 }, function() {
        ...
        a.cssHooks[e + t] = {
          expand: function(f) {
            for (var r = 0, o = {}, _ = typeof f == "string" ? f.split(" ") : [f]; r < 4; r++)
              o[e + qe[r] + t] = _[r] || _[r - 2] || _[0];
            return o;
          }
        }, e !== "margin" && (a.cssHooks[e + t].set = yf);
      }), a.fn.extend({
        css: function(e, t) {
          return Ke(this, function(f, r, o) {
            var _, i, u = {}, h = 0;
            if (Array.isArray(r)) {
              for (_ = Nt(f), i = r.length; h < i; h++)
                u[r[h]] = a.css(f, r[h], !1, _);
              return u;
            }
            return o !== void 0 ? a.style(f, r, o) : a.css(f, r);
          }, e, t, arguments.length > 1);
        }
      });
      function Re(e, t, f, r, o) {
        return new Re.prototype.init(e, t, f, r, o);
      }
      a.Tween = Re, Re.prototype = {
        constructor: Re,
        init: function(e, t, f, r, o, _) {
          this.elem = e, this.prop = f, this.easing = o || a.easing._default, this.options = t, this.start = this.now = this.cur(), this.end = r, this.unit = _ || (a.cssNumber[f] ? "" : "px");
        },
        cur: function() {
        ...
        run: function(e) {
          var t, f = Re.propHooks[this.prop];
          ...
          ) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), f && f.set ? f.set(this) : Re.propHooks._default.set(this), this;
        }
        ...
        _default: {
          ...
          set: function(e) {
            a.fx.step[e.prop] ? a.fx.step[e.prop](e) : e.elem.nodeType === 1 && (a.cssHooks[e.prop] || e.elem.style[Kt(e.prop)] != null) ? a.style(e.elem, e.prop, e.now + e.unit) : e.elem[e.prop] = e.now;
          }
        }
      ...
      var ht, Ct, ur = /^(?:toggle|show|hide)$/, lr = /queueHooks$/;
      function zt() {
        Ct && (E.hidden === !1 && V.requestAnimationFrame ? V.requestAnimationFrame(zt) : V.setTimeout(zt, a.fx.interval), a.fx.tick());
      }
      function vf() {
      ...
      function kt(e, t) {
        var f, r = 0, o = { height: e };
        for (t = t ? 1 : 0; r < 4; r += 2 - t)
          f = qe[r], o["margin" + f] = o["padding" + f] = e;
        return t && (o.opacity = o.width = e), o;
      }
      function Nf(e, t, f) {
        for (var r, o = (ke.tweeners[t] || []).concat(ke.tweeners["*"]), _ = 0, i = o.length; _ < i; _++)
          if (r = o[_].call(f, t, e))
            return r;
      }
      function dr(e, t, f) {
        var r, o, _, i, u, h, p, R, y = "width" in t || "height" in t, O = this, C = {}, J = e.style, _e = e.nodeType && St(e), te = z.get(e, "fxshow");
        f.queue || (i = a._queueHooks(e, "fx"), i.unqueued == null && (i.unqueued = 0, u = i.empty.fire, i.empty.fire = function() {
          i.unqueued || u();
        ...
        for (r in t)
          if (o = t[r], ur.test(o)) {
            if (delete t[r], _ = _ || o === "toggle", o === (_e ? "hide" : "show"))
              if (o === "show" && te && te[r] !== void 0)
                _e = !0;
              else
                continue;
            C[r] = te && te[r] || a.style(e, r);
          }
        if (h = !a.isEmptyObject(t), !(!h && a.isEmptyObject(C))) {
          y && e.nodeType === 1 && (f.overflow = [J.overflow, J.overflowX, J.overflowY], p = te && te.display, p == null && (p = z.get(e, "display")), R = a.css(e, "display"), R === "none" && (p ? R = p : (it([e], !0), p = e.style.display || p, R = a.css(e, "display"), it([e]))), (R === "inline" || R === "inline-block" && p != null) && a.css(e, "float") === "none" && (h || (O.done(function() {
            J.display = p;
          }), p == null && (R = J.display, p = R === "none" ? "" : R)), J.display = "inline-block")), f.overflow && (J.overflow = "hidden", O.always(function() {
            J.overflow = f.overflow[0], J.overflowX = f.overflow[1], J.overflowY = f.overflow[2];
          })), h = !1;
          for (r in C)
            h || (te ? "hidden" in te && (_e = te.hidden) : te = z.access(e, "fxshow", { display: p }), _ && (te.hidden = !_e), _e && it([e], !0), O.done(function() {
              _e || it([e]), z.remove(e, "fxshow");
              for (r in C)
                a.style(e, r, C[r]);
            })), h = Nf(_e ? te[r] : 0, r, O), r in te || (te[r] = h.start, _e && (h.end = h.start, h.start = 0));
        }
      }
      function cr(e, t) {
        var f, r, o, _, i;
        for (f in e)
          if (r = He(f), o = t[r], _ = e[f], Array.isArray(_) && (o = _[1], _ = e[f] = _[0]), f !== r && (e[r] = _, delete e[f]), i = a.cssHooks[r], i && "expand" in i) {
            _ = i.expand(_), delete e[r];
            for (f in _)
              f in e || (e[f] = _[f], t[f] = o);
          } else
            t[r] = o;
      }
      function ke(e, t, f) {
        var r, o, _ = 0, i = ke.prefilters.length, u = a.Deferred().always(function() {
          delete h.elem;
        }), h = function() {
          if (o)
            return !1;
          for (var y = ht || vf(), O = Math.max(0, p.startTime + p.duration - y), C = O / p.duration || 0, J = 1 - C, _e = 0, te = p.tweens.length; _e < te; _e++)
            p.tweens[_e].run(J);
          return u.notifyWith(e, [p, J, O]), J < 1 && te ? O : (te || u.notifyWith(e, [p, 1, 0]), u.resolveWith(e, [p]), !1);
        }, p = u.promise({
          elem: e,
          props: a.extend({}, t),
          opts: a.extend(!0, {
          ...
          duration: f.duration,
          tweens: [],
          createTween: function(y, O) {
            var C = a.Tween(
              e,
              p.opts,
              y,
              O,
              p.opts.specialEasing[y] || p.opts.easing
            );
            return p.tweens.push(C), C;
          },
          stop: function(y) {
            var O = 0, C = y ? p.tweens.length : 0;
            if (o)
              return this;
            for (o = !0; O < C; O++)
              p.tweens[O].run(1);
            return y ? (u.notifyWith(e, [p, 1, 0]), u.resolveWith(e, [p, y])) : u.rejectWith(e, [p, y]), this;
          }
        }), R = p.props;
        for (cr(R, p.opts.specialEasing); _ < i; _++)
          if (r = ke.prefilters[_].call(p, e, R, p.opts), r)
            return l(r.stop) && (a._queueHooks(p.elem, p.opts.queue).stop = r.stop.bind(r)), r;
        return a.map(R, Nf, p), l(p.opts.start) && p.opts.start.call(e, p), p.progress(p.opts.progress).done(p.opts.done, p.opts.complete).fail(p.opts.fail).always(p.opts.always), a.fx.timer(
          a.extend(h, {
            elem: e,
            anim: p,
            queue: p.opts.queue
      ...
      a.Animation = a.extend(ke, {
        tweeners: {
          "*": [function(e, t) {
            var f = this.createTween(e, t);
            return uf(f.elem, e, pt.exec(t), f), f;
          }]
        },
        tweener: function(e, t) {
          l(e) ? (t = e, e = ["*"]) : e = e.match(ce);
          for (var f, r = 0, o = e.length; r < o; r++)
            f = e[r], ke.tweeners[f] = ke.tweeners[f] || [], ke.tweeners[f].unshift(t);
        },
        prefilters: [dr],
        prefilter: function(e, t) {
          t ? ke.prefilters.unshift(e) : ke.prefilters.push(e);
        }
      }), a.speed = function(e, t, f) {
        var r = e && typeof e == "object" ? a.extend({}, e) : {
          complete: f || !f && t || l(e) && e,
          duration: e,
          easing: f && t || t && !l(t) && t
        };
        return a.fx.off ? r.duration = 0 : typeof r.duration != "number" && (r.duration in a.fx.speeds ? r.duration = a.fx.speeds[r.duration] : r.duration = a.fx.speeds._default), (r.queue == null || r.queue === !0) && (r.queue = "fx"), r.old = r.complete, r.complete = function() {
          l(r.old) && r.old.call(this), r.queue && a.dequeue(this, r.queue);
        }, r;
      }, a.fn.extend({
        fadeTo: function(e, t, f, r) {
          return this.filter(St).css("opacity", 0).show().end().animate({ opacity: t }, e, f, r);
        },
        animate: function(e, t, f, r) {
          var o = a.isEmptyObject(e), _ = a.speed(t, f, r), i = function() {
            var u = ke(this, a.extend({}, e), _);
            (o || z.get(this, "finish")) && u.stop(!0);
          };
          return i.finish = i, o || _.queue === !1 ? this.each(i) : this.queue(_.queue, i);
        },
        stop: function(e, t, f) {
          var r = function(o) {
            var _ = o.stop;
          ...
          return typeof e != "string" && (f = t, t = e, e = void 0), t && this.queue(e || "fx", []), this.each(function() {
            var o = !0, _ = e != null && e + "queueHooks", i = a.timers, u = z.get(this);
            if (_)
              u[_] && u[_].stop && r(u[_]);
            else
              for (_ in u)
                u[_] && u[_].stop && lr.test(_) && r(u[_]);
            for (_ = i.length; _--; )
              i[_].elem === this && (e == null || i[_].queue === e) && (i[_].anim.stop(f), o = !1, i.splice(_, 1));
            (o || !f) && a.dequeue(this, e);
          });
        },
        finish: function(e) {
          return e !== !1 && (e = e || "fx"), this.each(function() {
            var t, f = z.get(this), r = f[e + "queue"], o = f[e + "queueHooks"], _ = a.timers, i = r ? r.length : 0;
            for (f.finish = !0, a.queue(this, e, []), o && o.stop && o.stop.call(this, !0), t = _.length; t--; )
              _[t].elem === this && _[t].queue === e && (_[t].anim.stop(!0), _.splice(t, 1));
            for (t = 0; t < i; t++)
        ...
        var f = a.fn[t];
        a.fn[t] = function(r, o, _) {
          return r == null || typeof r == "boolean" ? f.apply(this, arguments) : this.animate(kt(t, !0), r, o, _);
        };
      }), a.each({
        slideDown: kt("show"),
        slideUp: kt("hide"),
        ...
        a.fn[e] = function(f, r, o) {
          return this.animate(t, f, r, o);
        };
      }), a.timers = [], a.fx.tick = function() {
        var e, t = 0, f = a.timers;
        for (ht = Date.now(); t < f.length; t++)
          e = f[t], !e() && f[t] === e && f.splice(t--, 1);
        f.length || a.fx.stop(), ht = void 0;
        ...
        return e = a.fx && a.fx.speeds[e] || e, t = t || "fx", this.queue(t, function(f, r) {
          var o = V.setTimeout(f, e);
          r.stop = function() {
            V.clearTimeout(o);
          };
        });
      }, (function() {
        var e = E.createElement("input"), t = E.createElement("select"), f = t.appendChild(E.createElement("option"));
        e.type = "checkbox", m.checkOn = e.value !== "", m.optSelected = f.selected, e = E.createElement("input"), e.value = "t", e.type = "radio", m.radioValue = e.value === "t";
      })();
      var Cf, Et = a.expr.attrHandle;
      a.fn.extend({
        attr: function(e, t) {
          return Ke(this, a.attr, e, t, arguments.length > 1);
        },
        ...
        attr: function(e, t, f) {
          var r, o, _ = e.nodeType;
          if (!(_ === 3 || _ === 8 || _ === 2)) {
            if (typeof e.getAttribute > "u")
              return a.prop(e, t, f);
            if ((_ !== 1 || !a.isXMLDoc(e)) && (o = a.attrHooks[t.toLowerCase()] || (a.expr.match.bool.test(t) ? Cf : void 0)), f !== void 0) {
              if (f === null) {
                a.removeAttr(e, t);
                return;
              }
              return o && "set" in o && (r = o.set(e, f, t)) !== void 0 ? r : (e.setAttribute(t, f + ""), f);
            }
            return o && "get" in o && (r = o.get(e, t)) !== null ? r : (r = a.find.attr(e, t), r ?? void 0);
          }
        },
        attrHooks: {
          type: {
            set: function(e, t) {
              if (!m.radioValue && t === "radio" && ee(e, "input")) {
                var f = e.value;
                return e.setAttribute("type", t), f && (e.value = f), t;
              }
            }
          }
        },
        removeAttr: function(e, t) {
          var f, r = 0, o = t && t.match(ce);
          if (o && e.nodeType === 1)
            for (; f = o[r++]; )
              e.removeAttribute(f);
        }
        ...
        set: function(e, t, f) {
          return t === !1 ? a.removeAttr(e, f) : e.setAttribute(f, f), f;
        }
      }, a.each(a.expr.match.bool.source.match(/\w+/g), function(e, t) {
        var f = Et[t] || a.find.attr;
        Et[t] = function(r, o, _) {
          var i, u, h = o.toLowerCase();
          return _ || (u = Et[h], Et[h] = i, i = f(r, o, _) != null ? h : null, Et[h] = u), i;
        };
      });
      var pr = /^(?:input|select|textarea|button)$/i, br = /^(?:a|area)$/i;
      a.fn.extend({
        prop: function(e, t) {
          return Ke(this, a.prop, e, t, arguments.length > 1);
        },
        ...
        prop: function(e, t, f) {
          var r, o, _ = e.nodeType;
          if (!(_ === 3 || _ === 8 || _ === 2))
            return (_ !== 1 || !a.isXMLDoc(e)) && (t = a.propFix[t] || t, o = a.propHooks[t]), f !== void 0 ? o && "set" in o && (r = o.set(e, f, t)) !== void 0 ? r : e[t] = f : o && "get" in o && (r = o.get(e, t)) !== null ? r : e[t];
        },
        propHooks: {
          tabIndex: {
            get: function(e) {
              var t = a.find.attr(e, "tabindex");
              return t ? parseInt(t, 10) : pr.test(e.nodeName) || br.test(e.nodeName) && e.href ? 0 : -1;
            }
          }
        },
        propFix: {
      ...
      function Vt(e) {
        return Array.isArray(e) ? e : typeof e == "string" ? e.match(ce) || [] : [];
      }
      a.fn.extend({
        addClass: function(e) {
          var t, f, r, o, _, i;
          return l(e) ? this.each(function(u) {
            a(this).addClass(e.call(this, u, ft(this)));
          }) : (t = Vt(e), t.length ? this.each(function() {
            if (r = ft(this), f = this.nodeType === 1 && " " + tt(r) + " ", f) {
              for (_ = 0; _ < t.length; _++)
                o = t[_], f.indexOf(" " + o + " ") < 0 && (f += o + " ");
              i = tt(f), r !== i && this.setAttribute("class", i);
            }
          }) : this);
        },
        removeClass: function(e) {
          var t, f, r, o, _, i;
          return l(e) ? this.each(function(u) {
            a(this).removeClass(e.call(this, u, ft(this)));
          }) : arguments.length ? (t = Vt(e), t.length ? this.each(function() {
            if (r = ft(this), f = this.nodeType === 1 && " " + tt(r) + " ", f) {
              for (_ = 0; _ < t.length; _++)
                for (o = t[_]; f.indexOf(" " + o + " ") > -1; )
                  f = f.replace(" " + o + " ", " ");
              i = tt(f), r !== i && this.setAttribute("class", i);
            }
        ...
        toggleClass: function(e, t) {
          var f, r, o, _, i = typeof e, u = i === "string" || Array.isArray(e);
          return l(e) ? this.each(function(h) {
            a(this).toggleClass(
              e.call(this, h, ft(this), t),
              t
            );
          }) : typeof t == "boolean" && u ? t ? this.addClass(e) : this.removeClass(e) : (f = Vt(e), this.each(function() {
            if (u)
              for (_ = a(this), o = 0; o < f.length; o++)
                r = f[o], _.hasClass(r) ? _.removeClass(r) : _.addClass(r);
            else (e === void 0 || i === "boolean") && (r = ft(this), r && z.set(this, "__className__", r), this.setAttribute && this.setAttribute(
              "class",
              r || e === !1 ? "" : z.get(this, "__className__") || ""
            ));
          }));
        },
        hasClass: function(e) {
          var t, f, r = 0;
          for (t = " " + e + " "; f = this[r++]; )
            if (f.nodeType === 1 && (" " + tt(ft(f)) + " ").indexOf(t) > -1)
              return !0;
          return !1;
        }
      });
      ...
      a.fn.extend({
        val: function(e) {
          var t, f, r, o = this[0];
          return arguments.length ? (r = l(e), this.each(function(_) {
            var i;
            this.nodeType === 1 && (r ? i = e.call(this, _, a(this).val()) : i = e, i == null ? i = "" : typeof i == "number" ? i += "" : Array.isArray(i) && (i = a.map(i, function(u) {
              return u == null ? "" : u + "";
            })), t = a.valHooks[this.type] || a.valHooks[this.nodeName.toLowerCase()], (!t || !("set" in t) || t.set(this, i, "value") === void 0) && (this.value = i));
          })) : o ? (t = a.valHooks[o.type] || a.valHooks[o.nodeName.toLowerCase()], t && "get" in t && (f = t.get(o, "value")) !== void 0 ? f : (f = o.value, typeof f == "string" ? f.replace(wr, "") : f ?? "")) : void 0;
        }
      }), a.extend({
        valHooks: {
          option: {
          ...
          select: {
            get: function(e) {
              var t, f, r, o = e.options, _ = e.selectedIndex, i = e.type === "select-one", u = i ? null : [], h = i ? _ + 1 : o.length;
              for (_ < 0 ? r = h : r = i ? _ : 0; r < h; r++)
                if (f = o[r], (f.selected || r === _) && // Don't return options that are disabled or in a disabled optgroup
                !f.disabled && (!f.parentNode.disabled || !ee(f.parentNode, "optgroup"))) {
                  if (t = a(f).val(), i)
                    return t;
                  u.push(t);
                }
            ...
            set: function(e, t) {
              for (var f, r, o = e.options, _ = a.makeArray(t), i = o.length; i--; )
                r = o[i], (r.selected = a.inArray(a.valHooks.option.get(r), _) > -1) && (f = !0);
              return f || (e.selectedIndex = -1), _;
            }
          }
        }
      ...
      var Tt = V.location, kf = { guid: Date.now() }, $t = /\?/;
      a.parseXML = function(e) {
        ...
        return f = t && t.getElementsByTagName("parsererror")[0], (!t || f) && a.error("Invalid XML: " + (f ? a.map(f.childNodes, function(r) {
          return r.textContent;
        }).join(`
`) : e)), t;
      };
      var Df = /^(?:focusinfocus|focusoutblur)$/, Mf = function(e) {
        e.stopPropagation();
      };
      a.extend(a.event, {
        trigger: function(e, t, f, r) {
          var o, _, i, u, h, p, R, y, O = [f || E], C = s.call(e, "type") ? e.type : e, J = s.call(e, "namespace") ? e.namespace.split(".") : [];
          if (_ = y = i = f = f || E, !(f.nodeType === 3 || f.nodeType === 8) && !Df.test(C + a.event.triggered) && (C.indexOf(".") > -1 && (J = C.split("."), C = J.shift(), J.sort()), h = C.indexOf(":") < 0 && "on" + C, e = e[a.expando] ? e : new a.Event(C, typeof e == "object" && e), e.isTrigger = r ? 2 : 3, e.namespace = J.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + J.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = f), t = t == null ? [e] : a.makeArray(t, [e]), R = a.event.special[C] || {}, !(!r && R.trigger && R.trigger.apply(f, t) === !1))) {
            if (!r && !R.noBubble && !w(f)) {
              for (u = R.delegateType || C, Df.test(u + C) || (_ = _.parentNode); _; _ = _.parentNode)
                O.push(_), i = _;
              i === (f.ownerDocument || E) && O.push(i.defaultView || i.parentWindow || V);
            }
            for (o = 0; (_ = O[o++]) && !e.isPropagationStopped(); )
              y = _, e.type = o > 1 ? u : R.bindType || C, p = (z.get(_, "events") || /* @__PURE__ */ Object.create(null))[e.type] && z.get(_, "handle"), p && p.apply(_, t), p = h && _[h], p && p.apply && dt(_) && (e.result = p.apply(_, t), e.result === !1 && e.preventDefault());
            return e.type = C, !r && !e.isDefaultPrevented() && (!R._default || R._default.apply(O.pop(), t) === !1) && dt(f) && h && l(f[C]) && !w(f) && (i = f[h], i && (f[h] = null), a.event.triggered = C, e.isPropagationStopped() && y.addEventListener(C, Mf), f[C](), e.isPropagationStopped() && y.removeEventListener(C, Mf), a.event.triggered = void 0, i && (f[h] = i)), e.result;
          }
        },
        // Piggyback on a donor event to simulate a different one
        // Used only for `focus(in | out)` events
        simulate: function(e, t, f) {
          var r = a.extend(
            new a.Event(),
            f,
            {
        ...
        triggerHandler: function(e, t) {
          var f = this[0];
          if (f)
            return a.event.trigger(e, t, f, !0);
        }
      });
      var Er = /\[\]$/, Gf = /\r?\n/g, Tr = /^(?:submit|button|image|reset|file)$/i, Or = /^(?:input|select|textarea|keygen)/i;
      function Qt(e, t, f, r) {
        var o;
        if (Array.isArray(t))
          a.each(t, function(_, i) {
            f || Er.test(e) ? r(e, i) : Qt(
              e + "[" + (typeof i == "object" && i != null ? _ : "") + "]",
              i,
              f,
              r
            );
          });
        else if (!f && j(t) === "object")
          for (o in t)
            Qt(e + "[" + o + "]", t[o], f, r);
        else
          r(e, t);
      ...
      a.param = function(e, t) {
        var f, r = [], o = function(_, i) {
          var u = l(i) ? i() : i;
          r[r.length] = encodeURIComponent(_) + "=" + encodeURIComponent(u ?? "");
        };
        if (e == null)
          return "";
        ...
        serializeArray: function() {
          return this.map(function() {
            ...
            var e = this.type;
            return this.name && !a(this).is(":disabled") && Or.test(this.nodeName) && !Tr.test(e) && (this.checked || !bt.test(e));
          }).map(function(e, t) {
            var f = a(this).val();
            return f == null ? null : Array.isArray(f) ? a.map(f, function(r) {
              return { name: t.name, value: r.replace(Gf, `\r
`) };
            }) : { name: t.name, value: f.replace(Gf, `\r
`) };
          }).get();
        }
      });
      var Ar = /%20/g, Ir = /#.*$/, Rr = /([?&])_=[^&]*/, jr = /^(.*?):[ \t]*([^\r\n]*)$/mg, Lr = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, yr = /^(?:GET|HEAD)$/, Sr = /^\/\//, Bf = {}, Xt = {}, Hf = "*/".concat("*"), Jt = E.createElement("a");
      Jt.href = Tt.href;
      function xf(e) {
        return function(t, f) {
          typeof t != "string" && (f = t, t = "*");
          var r, o = 0, _ = t.toLowerCase().match(ce) || [];
          if (l(f))
            for (; r = _[o++]; )
              r[0] === "+" ? (r = r.slice(1) || "*", (e[r] = e[r] || []).unshift(f)) : (e[r] = e[r] || []).push(f);
        };
      }
      function Pf(e, t, f, r) {
        var o = {}, _ = e === Xt;
        function i(u) {
          var h;
          return o[u] = !0, a.each(e[u] || [], function(p, R) {
            var y = R(t, f, r);
            if (typeof y == "string" && !_ && !o[y])
              return t.dataTypes.unshift(y), i(y), !1;
            if (_)
              return !(h = y);
          }), h;
        }
      ...
      function Zt(e, t) {
        var f, r, o = a.ajaxSettings.flatOptions || {};
        for (f in t)
          t[f] !== void 0 && ((o[f] ? e : r || (r = {}))[f] = t[f]);
        return r && a.extend(!0, e, r), e;
      }
      function vr(e, t, f) {
        for (var r, o, _, i, u = e.contents, h = e.dataTypes; h[0] === "*"; )
          h.shift(), r === void 0 && (r = e.mimeType || t.getResponseHeader("Content-Type"));
        if (r) {
          for (o in u)
            if (u[o] && u[o].test(r)) {
              h.unshift(o);
        ...
        if (_)
          return _ !== h[0] && h.unshift(_), f[_];
      }
      function Nr(e, t, f, r) {
        var o, _, i, u, h, p = {}, R = e.dataTypes.slice();
        if (R[1])
          for (i in e.converters)
            p[i.toLowerCase()] = e.converters[i];
        for (_ = R.shift(); _; )
          if (e.responseFields[_] && (f[e.responseFields[_]] = t), !h && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)), h = _, _ = R.shift(), _) {
            if (_ === "*")
              _ = h;
            else if (h !== "*" && h !== _) {
              if (i = p[h + " " + _] || p["* " + _], !i) {
                for (o in p)
                  if (u = o.split(" "), u[1] === _ && (i = p[h + " " + u[0]] || p["* " + u[0]], i)) {
                    i === !0 ? i = p[o] : p[o] !== !0 && (_ = u[0], R.unshift(u[1]));
                    break;
                  }
              }
              if (i !== !0)
                if (i && e.throws)
                  ...
                  try {
                    ...
                    return {
                      state: "parsererror",
                      error: i ? y : "No conversion from " + h + " to " + _
                    };
                  }
            }
          }
      ...
      a.extend({
        ...
        ajax: function(e, t) {
          ...
          var f, r, o, _, i, u, h, p, R, y, O = a.ajaxSetup({}, t), C = O.context || O, J = O.context && (C.nodeType || C.jquery) ? a(C) : a.event, _e = a.Deferred(), te = a.Callbacks("once memory"), be = O.statusCode || {}, pe = {}, xe = {}, Pe = "canceled", oe = {
            readyState: 0,
            ...
            getResponseHeader: function(ie) {
              ...
              if (h) {
                if (!_)
                  for (_ = {}; de = jr.exec(o); )
                    _[de[1].toLowerCase() + " "] = (_[de[1].toLowerCase() + " "] || []).concat(de[2]);
                de = _[ie.toLowerCase() + " "];
              }
            ...
            setRequestHeader: function(ie, de) {
              return h == null && (ie = xe[ie.toLowerCase()] = xe[ie.toLowerCase()] || ie, pe[ie] = de), this;
            },
            // Overrides response content-type header
            overrideMimeType: function(ie) {
              return h == null && (O.mimeType = ie), this;
            },
            ...
            abort: function(ie) {
              var de = ie || Pe;
              return f && f.abort(de), rt(0, de), this;
            }
          };
          if (_e.promise(oe), O.url = ((e || O.url || Tt.href) + "").replace(Sr, Tt.protocol + "//"), O.type = t.method || t.type || O.method || O.type, O.dataTypes = (O.dataType || "*").toLowerCase().match(ce) || [""], O.crossDomain == null) {
            u = E.createElement("a");
            try {
              u.href = O.url, u.href = u.href, O.crossDomain = Jt.protocol + "//" + Jt.host != u.protocol + "//" + u.host;
            } catch {
              O.crossDomain = !0;
            }
          }
          if (O.data && O.processData && typeof O.data != "string" && (O.data = a.param(O.data, O.traditional)), Pf(Bf, O, t, oe), h)
            return oe;
          p = a.event && O.global, p && a.active++ === 0 && a.event.trigger("ajaxStart"), O.type = O.type.toUpperCase(), O.hasContent = !yr.test(O.type), r = O.url.replace(Ir, ""), O.hasContent ? O.data && O.processData && (O.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (O.data = O.data.replace(Ar, "+")) : (y = O.url.slice(r.length), O.data && (O.processData || typeof O.data == "string") && (r += ($t.test(r) ? "&" : "?") + O.data, delete O.data), O.cache === !1 && (r = r.replace(Rr, "$1"), y = ($t.test(r) ? "&" : "?") + "_=" + kf.guid++ + y), O.url = r + y), O.ifModified && (a.lastModified[r] && oe.setRequestHeader("If-Modified-Since", a.lastModified[r]), a.etag[r] && oe.setRequestHeader("If-None-Match", a.etag[r])), (O.data && O.hasContent && O.contentType !== !1 || t.contentType) && oe.setRequestHeader("Content-Type", O.contentType), oe.setRequestHeader(
            "Accept",
            O.dataTypes[0] && O.accepts[O.dataTypes[0]] ? O.accepts[O.dataTypes[0]] + (O.dataTypes[0] !== "*" ? ", " + Hf + "; q=0.01" : "") : O.accepts["*"]
          );
          for (R in O.headers)
            oe.setRequestHeader(R, O.headers[R]);
          if (O.beforeSend && (O.beforeSend.call(C, oe, O) === !1 || h))
            return oe.abort();
          if (Pe = "abort", te.add(O.complete), oe.done(O.success), oe.fail(O.error), f = Pf(Xt, O, t, oe), !f)
            rt(-1, "No Transport");
          else {
            if (oe.readyState = 1, p && J.trigger("ajaxSend", [oe, O]), h)
              return oe;
            O.async && O.timeout > 0 && (i = V.setTimeout(function() {
              oe.abort("timeout");
            }, O.timeout));
            try {
              h = !1, f.send(pe, rt);
          ...
          function rt(ie, de, At, tf) {
            var Ye, It, Ue, Qe, Xe, Ne = de;
            h || (h = !0, i && V.clearTimeout(i), f = void 0, o = tf || "", oe.readyState = ie > 0 ? 4 : 0, Ye = ie >= 200 && ie < 300 || ie === 304, At && (Qe = vr(O, oe, At)), !Ye && a.inArray("script", O.dataTypes) > -1 && a.inArray("json", O.dataTypes) < 0 && (O.converters["text script"] = function() {
            }), Qe = Nr(O, Qe, oe, Ye), Ye ? (O.ifModified && (Xe = oe.getResponseHeader("Last-Modified"), Xe && (a.lastModified[r] = Xe), Xe = oe.getResponseHeader("etag"), Xe && (a.etag[r] = Xe)), ie === 204 || O.type === "HEAD" ? Ne = "nocontent" : ie === 304 ? Ne = "notmodified" : (Ne = Qe.state, It = Qe.data, Ue = Qe.error, Ye = !Ue)) : (Ue = Ne, (ie || !Ne) && (Ne = "error", ie < 0 && (ie = 0))), oe.status = ie, oe.statusText = (de || Ne) + "", Ye ? _e.resolveWith(C, [It, Ne, oe]) : _e.rejectWith(C, [oe, Ne, Ue]), oe.statusCode(be), be = void 0, p && J.trigger(
              Ye ? "ajaxSuccess" : "ajaxError",
              [oe, O, Ye ? It : Ue]
            ), te.fireWith(C, [oe, Ne]), p && (J.trigger("ajaxComplete", [oe, O]), --a.active || a.event.trigger("ajaxStop")));
          }
          return oe;
        },
        getJSON: function(e, t, f) {
          return a.get(e, t, f, "json");
        },
        getScript: function(e, t) {
          return a.get(e, void 0, t, "script");
        }
      }), a.each(["get", "post"], function(e, t) {
        a[t] = function(f, r, o, _) {
          return l(r) && (_ = _ || o, o = r, r = void 0), a.ajax(a.extend({
            url: f,
            type: t,
            dataType: _,
            data: r,
        ...
        wrapAll: function(e) {
          var t;
          return this[0] && (l(e) && (e = e.call(this[0])), t = a(e, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[0]), t.map(function() {
        ...
        wrapInner: function(e) {
          return l(e) ? this.each(function(t) {
            ...
            var t = a(this), f = t.contents();
            f.length ? f.wrapAll(e) : t.append(e);
          });
        },
        wrap: function(e) {
          var t = l(e);
          return this.each(function(f) {
            a(this).wrapAll(t ? e.call(this, f) : e);
          });
        },
        unwrap: function(e) {
      ...
      var Cr = {
        ...
        1223: 204
      }, Ot = a.ajaxSettings.xhr();
      m.cors = !!Ot && "withCredentials" in Ot, m.ajax = Ot = !!Ot, a.ajaxTransport(function(e) {
        var t, f;
        if (m.cors || Ot && !e.crossDomain)
          return {
            send: function(r, o) {
              var _, i = e.xhr();
              if (i.open(
              ...
              for (_ in r)
                i.setRequestHeader(_, r[_]);
              t = function(u) {
                return function() {
                  t && (t = f = i.onload = i.onerror = i.onabort = i.ontimeout = i.onreadystatechange = null, u === "abort" ? i.abort() : u === "error" ? typeof i.status != "number" ? o(0, "error") : o(
                    // File: protocol always yields status 0; see trac-8605, trac-14207
                    i.status,
                    i.statusText
                  ) : o(
                    Cr[i.status] || i.status,
                    i.statusText,
                    // Support: IE <=9 only
                    // IE9 has no XHR2 but throws on binary (trac-11426)
                    // For XHR2 non-text, let the caller handle it (gh-2498)
                    (i.responseType || "text") !== "text" || typeof i.responseText != "string" ? { binary: i.response } : { text: i.responseText },
                    i.getAllResponseHeaders()
                  ));
                };
              }, i.onload = t(), f = i.onerror = i.ontimeout = t("error"), i.onabort !== void 0 ? i.onabort = f : i.onreadystatechange = function() {
                i.readyState === 4 && V.setTimeout(function() {
                  t && f();
                });
              }, t = t("abort");
              try {
        ...
        if (e.crossDomain || e.scriptAttrs) {
          ...
          return {
            send: function(r, o) {
              t = a("<script>").attr(e.scriptAttrs || {}).prop({ charset: e.scriptCharset, src: e.url }).on("load error", f = function(_) {
                t.remove(), f = null, _ && o(_.type === "error" ? 404 : 200, _.type);
      ...
      a.ajaxSetup({
        ...
        jsonpCallback: function() {
          var e = Yf.pop() || a.expando + "_" + kf.guid++;
          return this[e] = !0, e;
        }
      }), a.ajaxPrefilter("json jsonp", function(e, t, f) {
        var r, o, _, i = e.jsonp !== !1 && (ef.test(e.url) ? "url" : typeof e.data == "string" && (e.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && ef.test(e.data) && "data");
        if (i || e.dataTypes[0] === "jsonp")
          return r = e.jsonpCallback = l(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, i ? e[i] = e[i].replace(ef, "$1" + r) : e.jsonp !== !1 && (e.url += ($t.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
            return _ || a.error(r + " was not called"), _[0];
          }, e.dataTypes[0] = "json", o = V[r], V[r] = function() {
            _ = arguments;
          }, f.always(function() {
            o === void 0 ? a(V).removeProp(r) : V[r] = o, e[r] && (e.jsonpCallback = t.jsonpCallback, Yf.push(r)), _ && l(o) && o(_[0]), _ = o = void 0;
          }), "script";
      }), m.createHTMLDocument = (function() {
        var e = E.implementation.createHTMLDocument("").body;
        return e.innerHTML = "<form></form><form></form>", e.childNodes.length === 2;
      })(), a.parseHTML = function(e, t, f) {
        if (typeof e != "string")
          return [];
        typeof t == "boolean" && (f = t, t = !1);
        var r, o, _;
        return t || (m.createHTMLDocument ? (t = E.implementation.createHTMLDocument(""), r = t.createElement("base"), r.href = E.location.href, t.head.appendChild(r)) : t = E), o = he.exec(e), _ = !f && [], o ? [t.createElement(o[1])] : (o = pf([e], t, _), _ && _.length && a(_).remove(), a.merge([], o.childNodes));
      }, a.fn.load = function(e, t, f) {
        var r, o, _, i = this, u = e.indexOf(" ");
        return u > -1 && (r = tt(e.slice(u)), e = e.slice(0, u)), l(t) ? (f = t, t = void 0) : t && typeof t == "object" && (o = "POST"), i.length > 0 && a.ajax({
          url: e,
          ...
          _ = arguments, i.html(r ? (
            // If a selector was specified, locate the right elements in a dummy div
            // Exclude scripts to avoid IE 'Permission Denied' errors
            a("<div>").append(a.parseHTML(h)).find(r)
          ) : (
            // Otherwise use the full result
            h
          ));
        }).always(f && function(h, p) {
          i.each(function() {
            f.apply(this, _ || [h.responseText, p, h]);
          });
        }), this;
        ...
        setOffset: function(e, t, f) {
          var r, o, _, i, u, h, p, R = a.css(e, "position"), y = a(e), O = {};
          R === "static" && (e.style.position = "relative"), u = y.offset(), _ = a.css(e, "top"), h = a.css(e, "left"), p = (R === "absolute" || R === "fixed") && (_ + h).indexOf("auto") > -1, p ? (r = y.position(), i = r.top, o = r.left) : (i = parseFloat(_) || 0, o = parseFloat(h) || 0), l(t) && (t = t.call(e, f, a.extend({}, u))), t.top != null && (O.top = t.top - u.top + i), t.left != null && (O.left = t.left - u.left + o), "using" in t ? t.using.call(e, O) : y.css(O);
        }
      }, a.fn.extend({
        ...
        offset: function(e) {
          ...
          var t, f, r = this[0];
          if (r)
            return r.getClientRects().length ? (t = r.getBoundingClientRect(), f = r.ownerDocument.defaultView, {
              top: t.top + f.pageYOffset,
              left: t.left + f.pageXOffset
            }) : { top: 0, left: 0 };
        },
        ...
        position: function() {
          if (this[0]) {
            var e, t, f, r = this[0], o = { top: 0, left: 0 };
            if (a.css(r, "position") === "fixed")
              t = r.getBoundingClientRect();
            else {
              for (t = this.offset(), f = r.ownerDocument, e = r.offsetParent || f.documentElement; e && (e === f.body || e === f.documentElement) && a.css(e, "position") === "static"; )
                e = e.parentNode;
              e && e !== r && e.nodeType === 1 && (o = a(e).offset(), o.top += a.css(e, "borderTopWidth", !0), o.left += a.css(e, "borderLeftWidth", !0));
            }
            return {
        ...
        var f = t === "pageYOffset";
        a.fn[e] = function(r) {
          return Ke(this, function(o, _, i) {
            var u;
            if (w(o) ? u = o : o.nodeType === 9 && (u = o.defaultView), i === void 0)
              return u ? u[t] : o[_];
            u ? u.scrollTo(
              f ? u.pageXOffset : i,
              f ? i : u.pageYOffset
        ...
        a.cssHooks[t] = Af(
          ...
          function(f, r) {
            if (r)
              return r = wt(f, t), Wt.test(r) ? a(f).position()[t] + "px" : r;
          }
        );
        ...
        a.each({
          ...
          a.fn[r] = function(o, _) {
            var i = arguments.length && (f || typeof o != "boolean"), u = f || (o === !0 || _ === !0 ? "margin" : "border");
            return Ke(this, function(h, p, R) {
              var y;
              return w(h) ? r.indexOf("outer") === 0 ? h["inner" + e] : h.document.documentElement["client" + e] : h.nodeType === 9 ? (y = h.documentElement, Math.max(
                h.body["scroll" + e],
                y["scroll" + e],
                h.body["offset" + e],
                y["offset" + e],
        ...
        bind: function(e, t, f) {
          return this.on(e, null, t, f);
        },
        unbind: function(e, t) {
          return this.off(e, null, t);
        },
        delegate: function(e, t, f, r) {
          return this.on(t, e, f, r);
        },
        undelegate: function(e, t, f) {
          return arguments.length === 1 ? this.off(e, "**") : this.off(t, e || "**", f);
        },
        hover: function(e, t) {
        ...
        function(e, t) {
          a.fn[t] = function(f, r) {
            return arguments.length > 0 ? this.on(t, null, f, r) : this.trigger(t);
          };
        }
      );
      ...
      a.proxy = function(e, t) {
        var f, r, o;
        if (typeof t == "string" && (f = e[t], t = e, e = f), !!l(e))
          return r = D.call(arguments, 2), o = function() {
            return e.apply(t || this, r.concat(D.call(arguments)));
          }, o.guid = e.guid = e.guid || a.guid++, o;
      }, a.holdReady = function(e) {
        e ? a.readyWait++ : a.ready(!0);
      }, a.isArray = Array.isArray, a.parseJSON = JSON.parse, a.nodeName = ee, a.isFunction = l, a.isWindow = w, a.camelCase = He, a.type = j, a.now = Date.now, a.isNumeric = function(e) {
        var t = a.type(e);
      ...
      var Dr = V.jQuery, Mr = V.$;
      return a.noConflict = function(e) {
        return V.$ === a && (V.$ = Mr), e && V.jQuery === a && (V.jQuery = Dr), a;
      }, typeof we > "u" && (V.jQuery = V.$ = a), a;
    });
  })(Ht)), Ht.exports;
}
var qf;
function qr() {
  return qf || (qf = 1, (function(Me, V) {
    (function(we, q) {
      Me.exports = q(Kr());
    })(window, function(we) {
      return (function(q) {
        ...
        function D(S) {
          ...
          var G = W[S] = { i: S, l: !1, exports: {} };
          return q[S].call(G.exports, G, G.exports, D), G.l = !0, G.exports;
        }
        return D.m = q, D.c = W, D.d = function(S, G, P) {
          D.o(S, G) || Object.defineProperty(S, G, { enumerable: !0, get: P });
        }, D.r = function(S) {
          typeof Symbol < "u" && Symbol.toStringTag && Object.defineProperty(S, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(S, "__esModule", { value: !0 });
        }, D.t = function(S, G) {
          if (1 & G && (S = D(S)), 8 & G || 4 & G && typeof S == "object" && S && S.__esModule) return S;
          var P = /* @__PURE__ */ Object.create(null);
          if (D.r(P), Object.defineProperty(P, "default", { enumerable: !0, value: S }), 2 & G && typeof S != "string") for (var B in S) D.d(P, B, (function(c) {
            return S[c];
          }).bind(null, B));
          return P;
        }, D.n = function(S) {
          var G = S && S.__esModule ? function() {
            return S.default;
          } : function() {
            return S;
          };
        ...
        Object.defineProperty(W, "__esModule", { value: !0 }), W.Converters = void 0;
        var S = /* @__PURE__ */ (function() {
          ...
          return function(g, b, m) {
            return b && s(g.prototype, b), m && s(g, m), g;
          };
        })(), G = B(D(17)), P = B(D(3));
        function B(s) {
          return s && s.__esModule ? s : { default: s };
        }
        var c = W.Converters = (function() {
          function s() {
            (function(g, b) {
              if (!(g instanceof b)) throw new TypeError("Cannot call a class as a function");
            })(this, s), this.unicode = s.unified, this.env = s.environment, this.css = s.image, this.is_mobile = s.deviceIsMobile, P.default.use_sheets && this.setSheets(P.default.sheets);
          }
          return S(s, null, [{ key: "factory", value: function() {
            return new s();
          } }]), S(s, [{ key: "setSheets", value: function(g) {
            g = g || P.default.sheets, [this.withEnvironment(), this.withImage()].forEach(function(b) {
              b.img_sets.apple.sheet = g.apple, b.img_sets.google.sheet = g.google, b.img_sets.twitter.sheet = g.twitter, b.use_sheet = !0;
            });
          } }, { key: "withUnified", value: function() {
            return this.unicode;
          } }, { key: "withEnvironment", value: function() {
            return this.env;
          } }, { key: "withImage", value: function() {
            return this.css;
          } }, { key: "canSupportUnified", value: function() {
            return this.env.replace_mode === "unified";
          } }], [{ key: "unified", get: function() {
            var g = new G.default();
            return g.init_unified(), g;
          } }, { key: "environment", get: function() {
            var g = new G.default();
            return g.init_env(), g.replace_mode === "img" || g.replace_mode === "css" ? s.image : g;
          } }, { key: "image", get: function() {
            var g = new G.default();
            return g.init_env(), g.replace_mode = "css", g.supports_css = !0, g;
          } }, { key: "deviceIsMobile", get: function() {
            var g, b = !1;
            return g = navigator.userAgent || navigator.vendor || window.opera, (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(g) || /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(g.substr(0, 4))) && (b = !0), b;
          } }]), s;
        })();
        W.default = new c();
      }, function(q, W, D) {
        var S = D(14);
        S.Template = D(13).Template, S.template = S.Template, q.exports = S;
      }, function(q, W, D) {
        Object.defineProperty(W, "__esModule", { value: !0 }), W.default = { categories: [{ title: "People", icon: '<i class="fa fa-smile-o" aria-hidden="true"></i>' }, { title: "Nature", icon: '<i class="fa fa-leaf" aria-hidden="true"></i>' }, { title: "Foods", icon: '<i class="fa fa-cutlery" aria-hidden="true"></i>' }, { title: "Activity", icon: '<i class="fa fa-futbol-o" aria-hidden="true"></i>' }, { title: "Places", icon: '<i class="fa fa-globe" aria-hidden="true"></i>' }, { title: "Symbols", icon: '<i class="fa fa-lightbulb-o" aria-hidden="true"></i>' }, { title: "Flags", icon: '<i class="fa fa-flag-checkered" aria-hidden="true"></i>' }], search_icon: '<i class="fa fa-search" aria-hidden="true"></i>', show_colon_preview: !0, prevent_new_line: !1, default_footer_message: "Please select an emoji from the list above", positioning: "autoplace", callback: void 0, onOpen: void 0, onReady: void 0, show_icon_tooltips: !0, use_sheets: !0, events: { SELECTED: "SELECTED", EMOJI_MOUSEENTER: "MOUSEENTER", EMOJI_MOUSELEAVE: "MOUSELEAVE" }, sheets: { apple: "./sheets/sheet_apple_64_indexed_128.png", google: "./sheets/sheet_google_64_indexed_128.png", twitter: "./sheets/sheet_twitter_64_indexed_128.png", emojione: "./sheets/sheet_emojione_64_indexed_128.png" } };
      }, function(q, W, D) {
        typeof Object.assign != "function" && (Object.assign = function(S, G) {
          if (S == null) throw new TypeError("Cannot convert undefined or null to object");
          for (var P = Object(S), B = 1; B < arguments.length; B++) {
            var c = arguments[B];
            if (c != null) for (var s in c) Object.prototype.hasOwnProperty.call(c, s) && (P[s] = c[s]);
          }
          return P;
        }), Array.prototype.find || Object.defineProperty(Array.prototype, "find", { value: function(S) {
          if (this == null) throw new TypeError('"this" is null or not defined');
          var G = Object(this), P = G.length >>> 0;
          if (typeof S != "function") throw new TypeError("predicate must be a function");
          for (var B = arguments[1], c = 0; c < P; ) {
            var s = G[c];
            if (S.call(B, s, c, G)) return s;
            c++;
          }
        } });
      }, function(q, W, D) {
        Object.defineProperty(W, "__esModule", { value: !0 }), W.Emoji = void 0;
        var S = /* @__PURE__ */ (function() {
          function s(g, b) {
            for (var m = 0; m < b.length; m++) {
              var l = b[m];
        ...
        })(), G = c(D(1)), P = c(D(0)), B = c(D(3));
        function c(s) {
          return s && s.__esModule ? s : { default: s };
        }
        D(4), W.Emoji = (function() {
          function s(g, b) {
            (function(m, l) {
              if (!(m instanceof l)) throw new TypeError("Cannot call a class as a function");
            })(this, s), this.has_apple_img = g.has_img_apple, this.has_google_img = g.has_img_google, this.has_twitter_img = g.has_img_twitter, this.has_emojione_img = g.has_img_emojione, this.category = b, this.full_name = g.name, this.short_name = g.short_name, this.short_names = g.short_names, this.sort_order = g.sort_order, this.hover_color = s.random_color, this.$emoji = this.getEmojiForPlatform(), this._bubble = void 0, this._onClick()._onHover();
          }
          return S(s, null, [{ key: "factory", value: function(g, b, m) {
            var l = new s(g, b);
            return l.setCallback(m), l;
          } }, { key: "randomIntFromInterval", value: function(g, b) {
            return Math.floor(Math.random() * (b - g + 1) + g);
          } }, { key: "random_color", get: function() {
            var g = ["blue", "yellow", "green", "orange", "indigo", "pink"];
            return g[s.randomIntFromInterval(0, g.length - 1)];
          } }]), S(s, [{ key: "getColons", value: function() {
            return ":" + this.short_name + ":";
          } }, { key: "getUnified", value: function() {
            return G.default.withUnified().replace_colons(this.getColons());
          } }, { key: "getImage", value: function() {
            return G.default.withImage().replace_colons(this.getColons());
          } }, { key: "getCodepoints", value: function() {
            var g = (0, P.default)(this.getImage());
            return g.hasClass("emoji-inner") ? g.data("codepoints") : g.find(".emoji-inner").data("codepoints");
          } }, { key: "getCharacter", value: function() {
            var g = this.getCodepoints();
            if (/-/g.test(g)) {
              var b = g.split("-").map(function(m) {
                return "0x" + m;
              });
              return String.fromCodePoint.apply(String, (function(m) {
                if (Array.isArray(m)) {
                  for (var l = 0, w = Array(m.length); l < m.length; l++) w[l] = m[l];
                  return w;
                }
                return Array.from(m);
              })(b));
          ...
          } }, { key: "getEmojiForPlatform", value: function() {
            var g = G.default.withEnvironment().replace_colons(this.getColons());
            return this._getWrapper().append(g);
          } }, { key: "getPreview", value: function() {
            var g = G.default.withEnvironment().replace_colons(this.getColons());
            return this._getPreviewWrapper().append(g);
          } }, { key: "getMarkup", value: function() {
            return this.$emoji;
          } }, { key: "getHtml", value: function() {
            return this.$emoji.get(0).innerHTML;
          } }, { key: "setCallback", value: function(g) {
            return this._bubble = g, this;
          } }, { key: "matchesSearchTerm", value: function(g) {
            return this.short_names.find(function(b) {
              return g.test(b);
            });
          } }, { key: "_getWrapper", value: function() {
            return (0, P.default)('<span class = "emoji-char-wrapper ' + this.hover_color + '" data-name="' + this.full_name + '" data-category="' + this.category + '"></span>');
          } }, { key: "_getPreviewWrapper", value: function() {
            return (0, P.default)('<span class = "emoji-preview-wrapper ' + this.hover_color + '" data-name="' + this.full_name + '" data-category="' + this.category + '"></span>');
          } }, { key: "_onClick", value: function() {
            var g = this;
            return (0, P.default)(this.$emoji).off("click.emoji").on("click.emoji", function(b) {
              g._bubble && g._bubble(B.default.events.SELECTED, g);
            }), this;
          } }, { key: "_onHover", value: function() {
            var g = this;
            return (0, P.default)(this.$emoji).off("mouseenter.emoji").on("mouseenter.emoji", function() {
              g._bubble(B.default.events.EMOJI_MOUSEENTER, g);
            }).off("mouseleave.emoji").on("mouseleave.emoji", function() {
              g._bubble(B.default.events.EMOJI_MOUSELEAVE, g);
            }), this;
          } }], [{ key: "supportsUnified", value: function() {
            return G.default.withEnvironment().replace_mode === "unified";
          } }]), s;
        })();
      }, function(q, W, D) {
        Object.defineProperty(W, "__esModule", { value: !0 }), W.EmojiCategory = void 0;
        var S = /* @__PURE__ */ (function() {
          function s(g, b) {
            for (var m = 0; m < b.length; m++) {
              var l = b[m];
        ...
        })(), G = D(5), P = c(D(15)), B = c(D(0));
        function c(s) {
          return s && s.__esModule ? s : { default: s };
        }
        W.EmojiCategory = (function() {
          function s(g, b) {
            var m = this;
            (function(w, E) {
              if (!(w instanceof E)) throw new TypeError("Cannot call a class as a function");
            })(this, s), this.title = g.title, this.icon = g.icon, this.emojis = b.map(function(w) {
              return G.Emoji.factory(w, m.title, m._onEvent.bind(m));
            }).sort(function(w, E) {
              return w.sort_order - E.sort_order;
            }), this.$category = this.getMarkup(), this.$title = this.$category.find(".category-title"), this._callback = void 0;
            var l = "";
            Object.defineProperty(this, "search_term", { get: function() {
              return l;
            }, set: function(w) {
              l !== w && (l = w, m._search());
            } });
          ...
          return S(s, null, [{ key: "factory", value: function(g, b, m) {
            var l = new s(g, b);
            return l.setCallback(m), l;
          } }]), S(s, [{ key: "exportContents", value: function() {
            return { title: this.title, icon: this.icon };
          } }, { key: "getMarkup", value: function() {
            if (this.$category) return this.$category;
            var g = (0, B.default)((0, P.default)({ title: this.title })), b = g.find(".category-content");
            return this.emojis.forEach(function(m) {
              b.append(m.getMarkup());
            }), g;
          } }, { key: "filter", value: function(g) {
            this.emojis.filter(function(b) {
              return !g(b);
            }).forEach(function(b) {
              return b.$emoji.hide();
            });
          } }, { key: "showAllEmojis", value: function() {
            this.emojis.forEach(function(g) {
              return g.$emoji.show();
            });
          } }, { key: "_onEvent", value: function(g, b) {
            this._callback && this._callback(g, b, this);
          } }, { key: "setCallback", value: function(g) {
            return this._callback = g, this;
          } }, { key: "_search", value: function() {
            if (this.search_term.trim().length === 0) this._clearSearch();
            else {
              this.$title.addClass("inactive");
              var g = new RegExp(this.search_term.toLowerCase());
              this.emojis.forEach(function(b) {
                b.matchesSearchTerm(g) ? b.$emoji.show() : b.$emoji.hide();
              });
            }
          } }, { key: "_clearSearch", value: function() {
            return this.$title.removeClass("inactive"), this.showAllEmojis(), this;
          } }, { key: "offset_top", get: function() {
            return this.$category.get(0).offsetTop;
          } }]), s;
        })();
      }, function(q, W, D) {
        Object.defineProperty(W, "__esModule", { value: !0 }), W.EmojiEditor = void 0;
        var S = /* @__PURE__ */ (function() {
          function c(s, g) {
          ...
          return function(s, g, b) {
            return g && c(s.prototype, g), b && c(s, b), s;
          };
        })(), G = B(D(0)), P = B(D(1));
        function B(c) {
          return c && c.__esModule ? c : { default: c };
        }
        W.EmojiEditor = (function() {
          function c(s) {
            var g = arguments.length > 1 && arguments[1] !== void 0 && arguments[1];
            (function(b, m) {
              if (!(b instanceof m)) throw new TypeError("Cannot call a class as a function");
            })(this, c), this._input = s, this._is_content_editable = this.isContentEditable(s), this.cursor_position = void 0, this.prevent_new_line = g, this._trackCursor(), this._onPaste();
          }
          return S(c, [{ key: "isContentEditable", value: function(s) {
            var g = s.nodeName;
            return s.isContentEditable && g !== "INPUT" && g !== "TEXTAREA";
          } }, { key: "placeEmoji", value: function(s) {
            if (this._input.focus(), this.cursor_position && c.restoreSelection(this.cursor_position), this._is_content_editable) {
              var g = void 0;
              return c.supportsUnified() ? (g = c.pasteTextAtCaret(s.getCharacter()), c.selectElement(g), this.cursor_position = c.saveSelection()) : (g = c.pasteHtml(s.getHtml()), this.cursor_position = c.saveSelection()), (0, G.default)(this._input).trigger("change").trigger("input"), g;
            }
            var b = this.pasteInputText(s.getColons());
            return (0, G.default)(this._input).trigger("change").trigger("input"), b;
          } }, { key: "pasteInputText", value: function(s) {
            var g = this._input.selectionStart, b = this._input.value.length;
            return this._input.value = this._input.value.substr(0, g) + s + this._input.value.substr(g), this.setInputCaretPosition(g + this._input.value.length - b), s;
          } }, { key: "setInputCaretPosition", value: function(s) {
            if (this._input.createTextRange) {
              var g = this._input.createTextRange();
              return g.move("character", s), g.select(), !0;
            }
            return this._input.selectionStart || this._input.selectionStart === 0 ? (this._input.focus(), this._input.setSelectionRange(s, s), !0) : (this._input.focus(), !1);
          } }, { key: "getText", value: function() {
            return this._is_content_editable ? this._mapElement(this._input).replace(/[\u200B-\u200D\uFEFF]/g, "") : P.default.withUnified().replace_colons(this._input.value);
          } }, { key: "empty", value: function() {
            this._is_content_editable ? this._input.innerHTML = "" : this._input.value = "";
          } }, { key: "_onPaste", value: function() {
            return this._is_content_editable && (0, G.default)(this._input).off("paste.editable").on("paste.editable", function(s) {
              s.stopPropagation(), s.preventDefault();
              var g = (s.originalEvent.clipboardData || window.clipboardData).getData("text"), b = c.pasteTextAtCaret(g);
              c.selectElement(b);
            }), this;
          } }, { key: "getNodes", value: function() {
            return Array.prototype.slice.call(this._input.childNodes);
          } }, { key: "selectLastNode", value: function() {
            var s = this.getNodes();
            s.length && (c.selectElement(s[s.length - 1]), this.cursor_position = c.saveSelection());
          } }, { key: "_mapElement", value: function(s) {
            var g = this;
            return Array.prototype.slice.call(s.childNodes).map(function(b) {
              var m = b instanceof Text, l = b instanceof HTMLElement;
              return m ? b.textContent : l && b.tagName === "SPAN" ? c._extractSpan(b) : l && b.tagName === "IMG" ? c._extractImage(b) : l && b.tagName === "BR" ? `
` : l ? g._mapElement(b) : "";
            }).join("");
          } }, { key: "_trackCursor", value: function() {
            var s = this;
            return this._is_content_editable && ((0, G.default)(this._input).off("keyup.emoji mouseup.emoji").on("keyup.emoji mouseup.emoji", function() {
              s.cursor_position = c.saveSelection();
            }), (0, G.default)(this._input).off("keydown.emoji").on("keydown.emoji", function(g) {
              g.which === 13 && s.prevent_new_line && g.preventDefault();
            })), this;
          } }, { key: "replaceUnified", value: function() {
            if (!this._is_content_editable) throw new Error("The replaceUnified method should only be called on contenteditable elements.");
            var s = P.default.withEnvironment().replace_unified(this._input.innerHTML);
            c.selectElementContents(this._input);
            var g = c.pasteHtml(s);
            g && c.selectElement(g);
          } }], [{ key: "_extractSpan", value: function(s) {
            var g = (0, G.default)(s).find(".emoji-inner");
            if (!g.length) return "";
            try {
              var b = g.data("codepoints");
              return c.parseCodepoints(b);
            } catch {
              return "";
            }
          } }, { key: "_extractImage", value: function(s) {
            return s.hasAttribute("data-codepoints") ? c.parseCodepoints(s.getAttribute("data-codepoints")) : "";
          } }, { key: "parseCodepoints", value: function(s) {
            if (/-/g.test(s)) {
              var g = s.split("-"), b = "0x" + g[0], m = "0x" + g[1];
              return String.fromCodePoint(b, m);
            }
            return String.fromCodePoint("0x" + s);
          } }, { key: "supportsUnified", value: function() {
            return P.default.withEnvironment().replace_mode === "unified";
          } }, { key: "pasteHtml", value: function(s) {
            return c.pasteHtmlAtCaret(s + "&#8203;");
          } }, { key: "saveSelection", value: function() {
            if (window.getSelection) {
              var s = window.getSelection();
              if (s.getRangeAt && s.rangeCount) return s.getRangeAt(0);
            } else if (document.selection && document.selection.createRange) return document.selection.createRange();
            return null;
          } }, { key: "restoreSelection", value: function(s) {
            if (s) if (window.getSelection) {
              var g = window.getSelection();
              g.removeAllRanges(), g.addRange(s);
            } else document.selection && s.select && s.select();
          } }, { key: "pasteTextAtCaret", value: function(s) {
            var g = void 0, b = void 0, m = document.createTextNode(s);
            return window.getSelection ? (g = window.getSelection()).getRangeAt && g.rangeCount && ((b = g.getRangeAt(0)).deleteContents(), b.insertNode(m)) : document.selection && document.selection.createRange && (document.selection.createRange().text = m.textContent), m;
          } }, { key: "selectElement", value: function(s) {
            var g = arguments.length > 1 && arguments[1] !== void 0 && arguments[1];
            if (window.getSelection) {
              var b = window.getSelection();
              b.removeAllRanges();
              var m = document.createRange();
              m.selectNodeContents(s), g || m.collapse(!1), b.addRange(m);
            } else if (document.selection) {
              var l = document.body.createTextRange();
              l.moveToElementText(s), l.select();
            }
          } }, { key: "pasteHtmlAtCaret", value: function(s, g) {
            var b = void 0, m = void 0;
            if (window.getSelection) {
              if ((b = window.getSelection()).getRangeAt && b.rangeCount) {
                (m = b.getRangeAt(0)).deleteContents();
                var l = document.createElement("div");
                l.innerHTML = s;
                for (var w = document.createDocumentFragment(), E = void 0, N = void 0; E = l.firstChild; ) N = w.appendChild(E);
                var A = w.firstChild;
                return m.insertNode(w), N && ((m = m.cloneRange()).setStartAfter(N), g ? m.setStartBefore(A) : m.collapse(!1), b.removeAllRanges(), b.addRange(m)), A;
              }
            } else if ((b = document.selection) && b.type != "Control") {
              var j = b.createRange();
              j.collapse(!0), b.createRange().pasteHTML(s), g && ((m = b.createRange()).setEndPoint("StartToStart", j), m.select());
            }
          } }, { key: "selectElementContents", value: function(s) {
            var g = document.createRange();
            g.selectNodeContents(s);
            var b = window.getSelection();
            b.removeAllRanges(), b.addRange(g);
          } }]), c;
        })();
      }, function(q, W, D) {
        var S = D(2);
        q.exports = function() {
          var G = new S.Template({ code: function(P, B, c) {
            var s = this;
            return s.b(c = c || ""), s.b('<div class = "icon-tooltip">'), s.b(`
` + c), s.b("    <span>"), s.b(s.v(s.f("text", P, B, 0))), s.b("</span>"), s.b(`
` + c), s.b("</div>"), s.fl();
          }, partials: {}, subs: {} }, `<div class = "icon-tooltip">
    <span>{{text}}</span>
</div>`, S);
        ...
        q.exports = function() {
          var G = new S.Template({ code: function(P, B, c) {
            var s = this;
            return s.b(c = c || ""), s.b('<div id = "emoji-picker">'), s.b(`
` + c), s.b('    <div class = "emoji-section emoji-header">'), s.b(`
` + c), s.s(s.f("categories", P, B, 1), P, B, 0, 96, 217, "{{ }}") && (s.rs(P, B, function(g, b, m) {
              m.b('            <div class = "select-category" data-name="'), m.b(m.v(m.f("title", g, b, 0))), m.b('">'), m.b(`
` + c), m.b("                "), m.b(m.t(m.f("icon", g, b, 0))), m.b(`
` + c), m.b("            </div>"), m.b(`
` + c);
            }), P.pop()), s.b("    </div>"), s.b(`
` + c), s.b('    <div class = "emoji-section emoji-search">'), s.b(`
` + c), s.b('        <div class = "search-wrapper">'), s.b(`
` + c), s.b('            <div class = "search-section centered">'), s.b(`
` + c), s.b("                "), s.b(s.t(s.f("search_icon", P, B, 0))), s.b(`
` + c), s.b("            </div>"), s.b(`
` + c), s.b('            <div class = "search-section input">'), s.b(`
` + c), s.b('                <input type="text" class = "search-emojis" placeholder="Search"/>'), s.b(`
` + c), s.b("            </div>"), s.b(`
` + c), s.b("        </div>"), s.b(`
` + c), s.b("    </div>"), s.b(`
` + c), s.b('    <div class = "emoji-title-overlay">'), s.b(`
` + c), s.b('        <span id = "active-title"></span>'), s.b(`
` + c), s.b("    </div>"), s.b(`
` + c), s.b('    <div class = "emoji-section emoji-content"></div>'), s.b(`
` + c), s.b('    <div class = "emoji-section emoji-footer">'), s.b(`
` + c), s.b('        <div class = "default-content">'), s.b(`
` + c), s.b("            <span>"), s.b(s.v(s.f("default_content", P, B, 0))), s.b("</span>"), s.b(`
` + c), s.b("        </div>"), s.b(`
` + c), s.b('        <div class = "emoji-preview">'), s.b(`
` + c), s.b('            <div class = "preview-section" id = "emoji-large-preview"></div>'), s.b(`
` + c), s.b('            <div class = "preview-section">'), s.b(`
` + c), s.b('                <span id = "emoji-name"></span>'), s.b(`
` + c), s.b('                <span id = "colon-display"></span>'), s.b(`
` + c), s.b("            </div>"), s.b(`
` + c), s.b("        </div>"), s.b(`
` + c), s.b("    </div>"), s.b(`
` + c), s.b("</div>"), s.fl();
          }, partials: {}, subs: {} }, `<div id = "emoji-picker">
    ...
    <div class = "emoji-section emoji-footer">
        ...
        q.exports = (function(S) {
          ...
          var B = Object.assign || function(b) {
            for (var m = 1; m < arguments.length; m++) {
              var l = arguments[m];
              for (var w in l) Object.prototype.hasOwnProperty.call(l, w) && (b[w] = l[w]);
            }
            return b;
          }, c = /* @__PURE__ */ (function() {
            function b(m, l) {
            ...
            return function(m, l, w) {
              return l && b(m.prototype, l), w && b(m, w), m;
            };
          })(), s = (function() {
            function b(m, l, w) {
              if ((function(E, N) {
                if (!(E instanceof N)) throw new TypeError("Cannot call a class as a function");
              })(this, b), !(w instanceof Element) && typeof w != "string") throw new TypeError("The tooltip passed to the constructor must be either an html string or an instance of HTMLElement");
              this.element = m, this.container = l, this.tooltip = w instanceof Element ? w : g(w).firstChild, this.element_rect = this.element.getBoundingClientRect(), this.container_rect = this.container.getBoundingClientRect(), this.container_dimension = this.calculateViewportPosition(), this.tooltip_dimension = {}, this.element_height = this.element.offsetHeight, this.element_width = this.element.offsetWidth, this.tooltip_height = 0, this.tooltip_width = 0, this.centered_coordinate = void 0, this.last_coordinate = void 0, this.placeTooltip();
            }
            return c(b, [{ key: "placeTooltip", value: function() {
              this.container.appendChild(this.tooltip), this.tooltip_height = this.tooltip.offsetHeight, this.tooltip_width = this.tooltip.offsetWidth, this.centered_coordinate = this.getCenteredStyles(), this._applyPosition(this.centered_coordinate);
            } }, { key: "_applyPosition", value: function(m) {
              var l = this;
              return m = this._composeCoordinates(m), this.tooltip.style.top = m.top + "px", this.tooltip.style.left = m.left + "px", function(w) {
                var E;
                w && (Array.isArray(w) ? (E = l.tooltip.classList).add.apply(E, (function(N) {
                  if (Array.isArray(N)) {
                    for (var A = 0, j = Array(N.length); A < N.length; A++) j[A] = N[A];
                    return j;
                  }
                  return Array.from(N);
                })(w)) : l.tooltip.classList.add(w));
              };
            } }, { key: "_composeCoordinates", value: function(m) {
              var l = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.last_coordinate;
              return this.last_coordinate = l ? { left: m.left === this.centered_coordinate.left ? l.left : m.left, top: m.top === this.centered_coordinate.top ? l.top : m.top } : m;
            } }, { key: "getCenteredStyles", value: function() {
              return { top: this.container_dimension.top - this.tooltip_height / 2 + this.element_rect.height / 2, left: this.container_dimension.left - this.tooltip_width / 2 + this.element_rect.width / 2 };
            } }, { key: "autoPlace", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, l = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, w = this.determineOffsetFromElement(), E = this._autoPlaceHorizontallyStyles(w, m), N = this._autoplaceVerticallyStyles(w, l), A = this._composeCoordinates(E, N);
              return this._applyPosition(A)([w.vertical, w.horizontal, "autoplace"]), this;
            } }, { key: "autoPlaceHorizontally", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, l = this.determineOffsetFromElement(), w = this._autoPlaceHorizontallyStyles(l, m);
              return this._applyPosition(w)(l.horizontal), this;
            } }, { key: "_autoPlaceHorizontallyStyles", value: function(m) {
              var l = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, w = m.horizontal === "TooltipLeft", E = this.element_width / 2 + this.tooltip_width / 2 - l;
              return { left: w ? this.centered_coordinate.left + E : this.centered_coordinate.left - E, top: this.centered_coordinate.top };
            } }, { key: "autoPlaceVertically", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, l = this.determineOffsetFromElement(), w = this._autoplaceVerticallyStyles(l, m);
              return this._applyPosition(w)(l.vertical), this;
            } }, { key: "_autoplaceVerticallyStyles", value: function(m) {
              var l = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, w = m.vertical === "TooltipAbove", E = this.element_height / 2 + this.tooltip_height / 2 + l;
              return { top: w ? this.centered_coordinate.top - E : this.centered_coordinate.top + E, left: this.centered_coordinate.left };
            } }, { key: "above", value: function(m) {
              var l = this._aboveStyles(m);
              return this._applyPosition(l)("TooltipAbove"), this;
            } }, { key: "_aboveStyles", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0;
              return { top: this.centered_coordinate.top - (this.element_height / 2 + this.tooltip_height / 2 + m), left: this.centered_coordinate.left };
            } }, { key: "below", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, l = this._belowStyles(m);
              return this._applyPosition(l)("TooltipBelow"), this;
            } }, { key: "_belowStyles", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0;
              return { top: this.centered_coordinate.top + (this.element_height / 2 + this.tooltip_height / 2 + m), left: this.centered_coordinate.left };
            } }, { key: "left", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, l = this._leftStyles(m);
              return this._applyPosition(l)("TooltipLeft"), this;
            } }, { key: "_leftStyles", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0;
              return { top: this.centered_coordinate.top, left: this.centered_coordinate.left - (this.element_width / 2 + this.tooltip_width / 2 + m) };
            } }, { key: "right", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, l = this._rightStyles(m);
              return this._applyPosition(l)("TooltipRight"), this;
            } }, { key: "_rightStyles", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0;
              return { top: this.centered_coordinate.top, left: this.centered_coordinate.left + (this.element_width / 2 + this.tooltip_width / 2 + m) };
            } }, { key: "alignLeft", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, l = this._alignLeftStyles(m);
              return this._applyPosition(l)("TooltipAlignLeft"), this;
            } }, { key: "_alignLeftStyles", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, l = (this.element_width - this.tooltip_width) / 2;
              return { top: this.centered_coordinate.top, left: this.centered_coordinate.left - l - m };
            } }, { key: "alignRight", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, l = this._alignRightStyles(m);
              return this._applyPosition(l)("TooltipAlignRight"), this;
            } }, { key: "_alignRightStyles", value: function() {
              var m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, l = (this.element_width - this.tooltip_width) / 2;
              return { top: this.centered_coordinate.top, left: this.centered_coordinate.left + l + m };
            } }, { key: "inside", value: function() {
              var m = this;
              return arguments.length && Array.prototype.slice.call(arguments).forEach(function(l) {
                switch (l) {
                  case "top":
                    m._insideTop();
                    break;
            ...
            } }, { key: "_insideTop", value: function() {
              return this._applyPosition(B({}, this.centered_coordinate, { top: this.centered_coordinate.top - this.centered_coordinate.top / 4 })), this;
            } }, { key: "_insideBottom", value: function() {
              return this._applyPosition(B({}, this.centered_coordinate, { top: this.centered_coordinate.top + this.centered_coordinate.top / 2 })), this;
            } }, { key: "center", value: function() {
              return this._removeClasses(), this.element_rect = this.element.getBoundingClientRect(), this.container_rect = this.container.getBoundingClientRect(), this.container_dimension = this.calculateViewportPosition(), this.tooltip_height = this.tooltip.offsetHeight, this.tooltip_width = this.tooltip.offsetWidth, this.centered_coordinate = this.getCenteredStyles(), this.tooltip.style.top = this.centered_coordinate.top + "px", this.tooltip.style.left = this.centered_coordinate.left + "px", this;
            } }, { key: "_removeClasses", value: function() {
              var m;
              return (m = this.tooltip.classList).remove.apply(m, ["TooltipAlignRight", "TooltipAlignLeft", "TooltipRight", "TooltipLeft", ",TooltipAbove", "TooltipBelow"]), this;
            } }, { key: "destroy", value: function() {
              return document.body.removeEventListener("click", this.destroy), this.tooltip.parentNode && this.tooltip.parentNode.removeChild(this.tooltip), this;
            } }, { key: "hide", value: function() {
              return this.tooltip.style.display = "none", this;
            } }, { key: "show", value: function() {
              return this.tooltip.style.display = "block", this;
            } }, { key: "removeListener", value: function() {
              var m = this;
              return setTimeout(function() {
                document.body.addEventListener("click", m.destroy.bind(m));
              }, 50), this;
            } }, { key: "setClickCallback", value: function(m, l) {
              var w = this;
              return m.stopPropagation(), document.body.addEventListener(m, function() {
                l.call(w, m.target, w.tooltip);
              }), this;
            } }, { key: "scrollWith", value: function(m) {
              var l = this, w = m.scrollTop;
              return m.addEventListener("scroll", function() {
                var E = w - m.scrollTop;
                l.tooltip.style.top = l.tooltip.style.top + E, w = m.scrollTop;
              }), this;
            } }, { key: "calculateViewportPosition", value: function() {
              var m = this.element_rect, l = this.container_rect;
              return { left: m.left - l.left + this.container.scrollLeft, top: m.top - l.top + this.container.scrollTop, right: m.right - l.right, bottom: m.bottom - l.bottom, width: m.width, height: m.height };
            } }, { key: "determineOffsetFromElement", value: function() {
              var m = window.innerHeight / 2, l = window.innerWidth / 2;
              return { horizontal: this.element_rect.left > l ? "TooltipRight" : "TooltipLeft", vertical: this.element_rect.top > m ? "TooltipAbove" : "TooltipBelow" };
            } }]), b;
          })();
          G.default = s;
          var g = function(b) {
            var m = document.createDocumentFragment(), l = document.createElement("div");
            l.innerHTML = b;
            for (var w = void 0; w = l.firstElementChild; ) m.appendChild(w);
            return m;
          };
        }]);
      }, function(q, W, D) {
        Object.defineProperty(W, "__esModule", { value: !0 }), W.EmojiPicker = void 0;
        var S = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(N) {
          ...
          return function(A, j, x) {
            return j && N(A.prototype, j), x && N(A, x), A;
          };
        })(), P = E(D(0)), B = D(7), c = D(6), s = E(D(1)), g = E(D(11)), b = E(D(10)), m = E(D(3)), l = E(D(9)), w = E(D(8));
        function E(N) {
          return N && N.__esModule ? N : { default: N };
        }
        D(4), W.EmojiPicker = (function() {
          function N() {
            var A = this, j = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : void 0;
            (function(fe, ee) {
              if (!(fe instanceof ee)) throw new TypeError("Cannot call a class as a function");
            })(this, N), this._callback = void 0, this.defaults = Object.assign({}, m.default), (j === void 0 ? "undefined" : S(j)) === "object" && this._setDefaults(j), typeof j == "function" && (this._callback = j), this.categories = this._getCategories(), this.$picker = this._getPicker(), this.$active_title = this.$picker.find("#active-title"), this.$preview_emoji = this.$picker.find("#emoji-large-preview"), this.$preview_name = this.$picker.find("#emoji-name"), this.$preview_colon = this.$picker.find("#colon-display"), this.$content = this.$picker.find(".emoji-content"), this.$default_footer = this.$picker.find(".default-content"), this.$preview = this.$picker.find(".emoji-preview"), this.$search = this.$picker.find(".search-emojis"), this._icon = void 0, this._container = void 0, this._input = void 0, this.editor = void 0;
            var x = !1;
            Object.defineProperty(this, "picker_open", { get: function() {
              return x;
            }, set: function(fe) {
              fe !== x && ((x = fe) || A.$picker.detach());
            } });
            var F = void 0;
            Object.defineProperty(this, "active_category", { get: function() {
              return F;
            }, set: function(fe) {
              (!F || fe instanceof c.EmojiCategory && fe.title !== F.title) && (F = fe, A.setActiveCategory());
            } });
            var a = void 0;
            Object.defineProperty(this, "active_emoji", { get: function() {
              return a;
            }, set: function(fe) {
              a && fe && fe.full_name === a.full_name || (a = fe, A._updatePreview());
            } }), this.active_category = this.categories[0], this._onScroll()._onCatClick()._onSearch()._setCategoryTooltips(), typeof this.defaults.onReady == "function" && this.defaults.onReady(this.categories);
          }
          return G(N, [{ key: "listenOn", value: function(A, j, x) {
            this._removeOldEvents(), this._icon = A, this._container = j, this._input = x, this.editor = new B.EmojiEditor(x, this.defaults.prevent_new_line), this._onIconClick();
          } }, { key: "openPicker", value: function(A) {
            var j = new g.default(this._icon, this._container, this.$picker.get(0));
            if (j.center(), typeof this.defaults.positioning == "function") this.defaults.positioning(j);
            else switch (this.defaults.positioning) {
              case "autoplace":
                j.autoPlace(43, 10);
                break;
              case "vertical":
                j.autoPlaceVertically(10);
                break;
              case "horizontal":
                j.autoPlaceHorizontally(10);
                break;
              default:
                j.autoPlace(43, 10);
            }
            return this._onTooltipClick(j, A), this.$content.get(0).scrollTop = this.active_category.offset_top, typeof this.defaults.onOpen == "function" && this.defaults.onOpen(), this;
          } }, { key: "getText", value: function() {
          ...
          } }, { key: "emptyInput", value: function() {
            this.editor ? this.editor.empty() : console.log("Did you call the listenOn method first? The EmojiEditor instance is undefined.");
          } }, { key: "setActiveCategory", value: function() {
            var A = this;
            return this.$picker.find(".select-category").each(function() {
              this.getAttribute("data-name") === A.active_category.title ? (this.classList.add("active"), A.$active_title.text(A.active_category.title)) : this.classList.remove("active");
            }), this;
          } }, { key: "setActiveCategoryByName", value: function(A) {
            var j = this.getCategory(A);
            if (console.log(j), !j) throw new ReferenceError("Your call to setActiveCategoryByName in rm-emoji-picker was not supplied a valid name. Valid names are: " + this.categories.map(function(x) {
              return x.title;
            }).join(", ").slice(0, -2));
            this.active_category = j;
          } }, { key: "getCategory", value: function(A) {
            return this.categories.find(function(j) {
              return j.title === A;
            });
          } }, { key: "getEmoji", value: function(A) {
            var j = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0;
            return j ? j.emojis.find(function(x) {
              return x.full_name === A;
            }) : this.categories.find(function(x) {
              return x.emojis.find(function(F) {
                return F.full_name === A;
              });
            });
          } }, { key: "_setDefaults", value: function(A) {
            var j = this;
            Object.keys(A).forEach(function(x) {
              j.defaults.hasOwnProperty(x) && (j.defaults[x] = A[x]);
            }), this.defaults.use_sheets && s.default.setSheets(this.defaults.sheets);
          } }, { key: "_dispatchBubble", value: function(A, j, x) {
            var F = m.default.events;
            switch (A) {
              case F.SELECTED:
                this._handleSelection(j, x);
                break;
              case F.EMOJI_MOUSEENTER:
                this.active_emoji = j;
                break;
              case F.EMOJI_MOUSELEAVE:
                this.active_emoji = void 0;
            }
          } }, { key: "_handleSelection", value: function(A, j) {
            var x = this.editor.placeEmoji(A);
            typeof this._callback == "function" && this._callback(A, j, x), typeof this.defaults.callback == "function" && this.defaults.callback(A, j, x), this.picker_open = !1, this.active_emoji = void 0;
          } }, { key: "_getCategories", value: function() {
            var A = this, j = this.defaults.categories.map(function(x) {
              return c.EmojiCategory.factory(x, b.default[x.title], A._dispatchBubble.bind(A));
            });
            return j[0].$category.addClass("first"), j;
          } }, { key: "_getPicker", value: function() {
            var A = (0, P.default)((0, l.default)({ default_content: m.default.default_footer_message, categories: this.categories.map(function(x) {
              return x.exportContents();
            }), search_icon: this.defaults.search_icon })), j = A.find(".emoji-content");
            return this.categories.forEach(function(x) {
              j.append(x.getMarkup());
            }), A;
          } }, { key: "_setCategoryTooltips", value: function() {
            if (this.$picker && this.defaults.show_icon_tooltips) {
              var A = this, j = void 0;
              this.$picker.find(".select-category").off("mouseenter.emoji").on("mouseenter.emoji", function(x) {
                var F = this.getAttribute("data-name");
                (j = new g.default(this, A.$picker.get(0), (0, w.default)({ text: F }))).below();
              }).off("mouseleave.emoji").on("mouseleave.emoji", function() {
                j.destroy();
              });
            }
            return this;
          } }, { key: "_removeOldEvents", value: function() {
            return this._icon && (0, P.default)(this._icon).off("click.emoji-picker"), this;
          } }, { key: "_onIconClick", value: function() {
            var A = this;
            return (0, P.default)(this._icon).off("click.emoji").on("click.emoji", function(j) {
              A.picker_open || A.openPicker(j), A.picker_open = !A.picker_open;
            }), this;
          } }, { key: "_onTooltipClick", value: function(A, j) {
            var x = this;
            A.setClickCallback(j, function(F, a) {
              var fe = (0, P.default)(F).closest("#emoji-picker"), ee = (0, P.default)(F).is(x._icon);
              fe.length || ee || (x.picker_open = !1);
            });
          } }, { key: "_onScroll", value: function() {
            var A = this;
            return this.$content.off("scroll.emoji").on("scroll.emoji", function(j) {
              A.active_category = A._getActiveCategory();
            }), this;
          } }, { key: "_onCatClick", value: function() {
            var A = this;
            return this.$picker.find(".select-category").off("click.emoji").on("click.emoji", function() {
              var j = A.getCategory(this.getAttribute("data-name"));
              A.$content.get(0).scrollTop = j.offset_top, A.active_category = A._getActiveCategory();
            }), this;
          } }, { key: "_onSearch", value: function() {
            var A = this;
            return this.$search.off("input.emoji").on("input.emoji", function() {
              var j = A.$search.val().trim();
              A.categories.forEach(function(x) {
                return x.search_term = j;
              }), A.$active_title.text("Results for: " + j), j.length === 0 && (A.active_category = A._getActiveCategory(), A.setActiveCategory());
            }), this;
          } }, { key: "_getActiveCategory", value: function() {
            for (var A = this.$content.get(0).scrollTop, j = this.categories[0], x = 0; x < this.categories.length; x++) {
              if (this.categories[x].offset_top > A) return j;
              j = this.categories[x];
            }
            return this.categories[this.categories.length - 1];
          } }, { key: "_updatePreview", value: function() {
            var A = this.active_emoji;
            A ? (this.$default_footer.hide(), this.$preview_emoji.html(A.getPreview()), this.$preview_name.text(A.short_name), this.defaults.show_colon_preview ? (this.$preview_colon.text(A.getColons()), this.$preview_name.removeClass("name-only")) : this.$preview_name.addClass("name-only"), this.$preview.show()) : (this.$preview.hide(), this.$default_footer.show());
          } }], [{ key: "render", value: function(A) {
            var j = s.default.withEnvironment();
            return s.default.is_mobile ? j.replace_colons(A) : j.replace_unified(j.replace_colons(A));
          } }, { key: "setSheets", value: function() {
            var A = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : void 0;
            A = A || m.default.sheets, s.default.setSheets(A);
          } }]), N;
        })();
      }, function(q, W, D) {
        (function(S) {
          function G(w, E, N) {
            var A;
            return E && typeof E == "object" && (E[w] !== void 0 ? A = E[w] : N && E.get && typeof E.get == "function" && (A = E.get(w))), A;
          }
          S.Template = function(w, E, N, A) {
            w = w || {}, this.r = w.code || this.r, this.c = N, this.options = A || {}, this.text = E || "", this.partials = w.partials || {}, this.subs = w.subs || {}, this.buf = "";
          }, S.Template.prototype = { r: function(w, E, N) {
            return "";
          }, v: function(w) {
            return w = m(w), b.test(w) ? w.replace(P, "&amp;").replace(B, "&lt;").replace(c, "&gt;").replace(s, "&#39;").replace(g, "&quot;") : w;
          }, t: m, render: function(w, E, N) {
            return this.ri([w], E || {}, N);
          }, ri: function(w, E, N) {
            return this.r(w, E, N);
          }, ep: function(w, E) {
            var N = this.partials[w], A = E[N.name];
            if (N.instance && N.base == A) return N.instance;
            if (typeof A == "string") {
              if (!this.c) throw new Error("No compiler available.");
              A = this.c.compile(A, this.options);
            }
            if (!A) return null;
            if (this.partials[w].base = A, N.subs) {
              for (key in E.stackText || (E.stackText = {}), N.subs) E.stackText[key] || (E.stackText[key] = this.activeSub !== void 0 && E.stackText[this.activeSub] ? E.stackText[this.activeSub] : this.text);
              A = (function(j, x, F, a, fe, ee) {
                function Ge() {
                }
                function v() {
                }
                var k;
                Ge.prototype = j, v.prototype = j.subs;
                var M = new Ge();
                for (k in M.subs = new v(), M.subsText = {}, M.buf = "", a = a || {}, M.stackSubs = a, M.subsText = ee, x) a[k] || (a[k] = x[k]);
                for (k in a) M.subs[k] = a[k];
                for (k in fe = fe || {}, M.stackPartials = fe, F) fe[k] || (fe[k] = F[k]);
                for (k in fe) M.partials[k] = fe[k];
                return M;
              })(A, N.subs, N.partials, this.stackSubs, this.stackPartials, E.stackText);
            }
            return this.partials[w].instance = A, A;
          }, rp: function(w, E, N, A) {
            var j = this.ep(w, N);
            return j ? j.ri(E, N, A) : "";
          }, rs: function(w, E, N) {
            var A = w[w.length - 1];
            if (l(A)) for (var j = 0; j < A.length; j++) w.push(A[j]), N(w, E, this), w.pop();
            else N(w, E, this);
          }, s: function(w, E, N, A, j, x, F) {
            var a;
            return (!l(w) || w.length !== 0) && (typeof w == "function" && (w = this.ms(w, E, N, A, j, x, F)), a = !!w, !A && a && E && E.push(typeof w == "object" ? w : E[E.length - 1]), a);
          }, d: function(w, E, N, A) {
            var j, x = w.split("."), F = this.f(x[0], E, N, A), a = this.options.modelGet, fe = null;
            if (w === "." && l(E[E.length - 2])) F = E[E.length - 1];
            else for (var ee = 1; ee < x.length; ee++) (j = G(x[ee], F, a)) !== void 0 ? (fe = F, F = j) : F = "";
            return !(A && !F) && (A || typeof F != "function" || (E.push(fe), F = this.mv(F, E, N), E.pop()), F);
          }, f: function(w, E, N, A) {
            for (var j = !1, x = !1, F = this.options.modelGet, a = E.length - 1; a >= 0; a--) if ((j = G(w, E[a], F)) !== void 0) {
              x = !0;
              break;
            }
            return x ? (A || typeof j != "function" || (j = this.mv(j, E, N)), j) : !A && "";
          }, ls: function(w, E, N, A, j) {
            var x = this.options.delimiters;
            return this.options.delimiters = j, this.b(this.ct(m(w.call(E, A)), E, N)), this.options.delimiters = x, !1;
          }, ct: function(w, E, N) {
            if (this.options.disableLambda) throw new Error("Lambda features disabled.");
            return this.c.compile(w, this.options).render(E, N);
          }, b: function(w) {
            this.buf += w;
          }, fl: function() {
            var w = this.buf;
            return this.buf = "", w;
          }, ms: function(w, E, N, A, j, x, F) {
            var a, fe = E[E.length - 1], ee = w.call(fe);
            return typeof ee == "function" ? !!A || (a = this.activeSub && this.subsText && this.subsText[this.activeSub] ? this.subsText[this.activeSub] : this.text, this.ls(ee, fe, N, a.substring(j, x), F)) : ee;
          }, mv: function(w, E, N) {
            var A = E[E.length - 1], j = w.call(A);
            return typeof j == "function" ? this.ct(m(j.call(A)), A, N) : j;
          }, sub: function(w, E, N, A) {
            var j = this.subs[w];
            j && (this.activeSub = w, j(E, N, this, A), this.activeSub = !1);
          } };
          var P = /&/g, B = /</g, c = />/g, s = /\'/g, g = /\"/g, b = /[&<>\"\']/;
          function m(w) {
            return String(w ?? "");
          }
          var l = Array.isArray || function(w) {
        ...
        (function(S) {
          ...
          function w(v, k, M) {
            if (k.charAt(M) != v.charAt(0)) return !1;
            for (var Q = 1, ue = v.length; Q < ue; Q++) if (k.charAt(M + Q) != v.charAt(Q)) return !1;
            return !0;
          }
          S.tags = { "#": 1, "^": 2, "<": 3, $: 4, "/": 5, "!": 6, ">": 7, "=": 8, _v: 9, "{": 10, "&": 11, _t: 12 }, S.scan = function(v, k) {
            var M = v.length, Q = 0, ue = null, Be = null, ne = "", le = [], Ee = !1, me = 0, Le = 0, he = "{{", ye = "}}";
            function lt() {
              ne.length > 0 && (le.push({ tag: "_t", text: new String(ne) }), ne = "");
            }
            function jt(Ze, ot) {
              if (lt(), Ze && (function() {
                for (var $e = !0, Se = Le; Se < le.length; Se++) if (!($e = S.tags[le[Se].tag] < S.tags._v || le[Se].tag == "_t" && le[Se].text.match(G) === null)) return !1;
                return $e;
              })()) for (var Fe, ce = Le; ce < le.length; ce++) le[ce].text && ((Fe = le[ce + 1]) && Fe.tag == ">" && (Fe.indent = le[ce].text.toString()), le.splice(ce, 1));
              else ot || le.push({ tag: `
` });
              Ee = !1, Le = le.length;
            }
            function xt(Ze, ot) {
              var Fe = "=" + ye, ce = Ze.indexOf(Fe, ot), $e = l(Ze.substring(Ze.indexOf("=", ot) + 1, ce)).split(" ");
              return he = $e[0], ye = $e[$e.length - 1], ce + Fe.length - 1;
            }
            for (k && (k = k.split(" "), he = k[0], ye = k[1]), me = 0; me < M; me++) Q == 0 ? w(he, v, me) ? (--me, lt(), Q = 1) : v.charAt(me) == `
` ? jt(Ee) : ne += v.charAt(me) : Q == 1 ? (me += he.length - 1, (ue = (Be = S.tags[v.charAt(me + 1)]) ? v.charAt(me + 1) : "_v") == "=" ? (me = xt(v, me), Q = 0) : (Be && me++, Q = 2), Ee = me) : w(ye, v, me) ? (le.push({ tag: ue, n: l(ne), otag: he, ctag: ye, i: ue == "/" ? Ee - he.length : me + ye.length }), ne = "", me += ye.length - 1, Q = 0, ue == "{" && (ye == "}}" ? me++ : m(le[le.length - 1]))) : ne += v.charAt(me);
            return jt(Ee, !0), le;
          };
          var E = { _t: !0, "\n": !0, $: !0, "/": !0 };
          function N(v, k) {
            for (var M = 0, Q = k.length; M < Q; M++) if (k[M].o == v.n) return v.tag = "#", !0;
          }
          function A(v, k, M) {
            for (var Q = 0, ue = M.length; Q < ue; Q++) if (M[Q].c == v && M[Q].o == k) return !0;
          }
          function j(v) {
            var k = [];
            for (var M in v.partials) k.push('"' + F(M) + '":{name:"' + F(v.partials[M].name) + '", ' + j(v.partials[M]) + "}");
            return "partials: {" + k.join(",") + "}, subs: " + (function(Q) {
              var ue = [];
              for (var Be in Q) ue.push('"' + F(Be) + '": function(c,p,t,i) {' + Q[Be] + "}");
              return "{ " + ue.join(",") + " }";
            })(v.subs);
          }
          S.stringify = function(v, k, M) {
            return "{code: function (c,p,i) { " + S.wrapMain(v.code) + " }," + j(v) + "}";
          };
          var x = 0;
          function F(v) {
            return v.replace(s, "\\\\").replace(P, '\\"').replace(B, "\\n").replace(c, "\\r").replace(g, "\\u2028").replace(b, "\\u2029");
          }
          function a(v) {
            return ~v.indexOf(".") ? "d" : "f";
          }
          function fe(v, k) {
            var M = "<" + (k.prefix || "") + v.n + x++;
            return k.partials[M] = { name: v.n, partials: {} }, k.code += 't.b(t.rp("' + F(M) + '",c,p,"' + (v.indent || "") + '"));', M;
          }
          function ee(v, k) {
            k.code += "t.b(t.t(t." + a(v.n) + '("' + F(v.n) + '",c,p,0)));';
          }
          function Ge(v) {
            return "t.b(" + v + ");";
          }
          S.generate = function(v, k, M) {
            x = 0;
            var Q = { code: "", subs: {}, partials: {} };
            return S.walk(v, Q), M.asString ? this.stringify(Q, k, M) : this.makeTemplate(Q, k, M);
          }, S.wrapMain = function(v) {
            return 'var t=this;t.b(i=i||"");' + v + "return t.fl();";
          }, S.template = S.Template, S.makeTemplate = function(v, k, M) {
            var Q = this.makePartials(v);
            return Q.code = new Function("c", "p", "i", this.wrapMain(v.code)), new this.template(Q, k, this, M);
          }, S.makePartials = function(v) {
            var k, M = { subs: {}, partials: v.partials, name: v.name };
            for (k in M.partials) M.partials[k] = this.makePartials(M.partials[k]);
            for (k in v.subs) M.subs[k] = new Function("c", "p", "t", "i", v.subs[k]);
            return M;
          }, S.codegen = { "#": function(v, k) {
            k.code += "if(t.s(t." + a(v.n) + '("' + F(v.n) + '",c,p,1),c,p,0,' + v.i + "," + v.end + ',"' + v.otag + " " + v.ctag + '")){t.rs(c,p,function(c,p,t){', S.walk(v.nodes, k), k.code += "});c.pop();}";
          }, "^": function(v, k) {
            k.code += "if(!t.s(t." + a(v.n) + '("' + F(v.n) + '",c,p,1),c,p,1,0,0,"")){', S.walk(v.nodes, k), k.code += "};";
          }, ">": fe, "<": function(v, k) {
            var M = { partials: {}, code: "", subs: {}, inPartial: !0 };
            S.walk(v.nodes, M);
            var Q = k.partials[fe(v, k)];
            Q.subs = M.subs, Q.partials = M.partials;
          }, $: function(v, k) {
            var M = { subs: {}, code: "", partials: k.partials, prefix: v.n };
            S.walk(v.nodes, M), k.subs[v.n] = M.code, k.inPartial || (k.code += 't.sub("' + F(v.n) + '",c,p,i);');
          }, "\n": function(v, k) {
            k.code += Ge('"\\n"' + (v.last ? "" : " + i"));
          }, _v: function(v, k) {
            k.code += "t.b(t.v(t." + a(v.n) + '("' + F(v.n) + '",c,p,0)));';
          }, _t: function(v, k) {
            k.code += Ge('"' + F(v.text) + '"');
          }, "{": ee, "&": ee }, S.walk = function(v, k) {
            for (var M, Q = 0, ue = v.length; Q < ue; Q++) (M = S.codegen[v[Q].tag]) && M(v[Q], k);
            return k;
          }, S.parse = function(v, k, M) {
            return (function Q(ue, Be, ne, le) {
              var Ee, me = [], Le = null, he = null;
              for (Ee = ne[ne.length - 1]; ue.length > 0; ) {
                if (he = ue.shift(), Ee && Ee.tag == "<" && !(he.tag in E)) throw new Error("Illegal content in < super tag.");
                if (S.tags[he.tag] <= S.tags.$ || N(he, le)) ne.push(he), he.nodes = Q(ue, he.tag, ne, le);
                else {
                  if (he.tag == "/") {
                    if (ne.length === 0) throw new Error("Closing tag without opener: /" + he.n);
                    if (Le = ne.pop(), he.n != Le.n && !A(he.n, Le.n, le)) throw new Error("Nesting error: " + Le.n + " vs. " + he.n);
                    return Le.end = he.i, me;
                  }
                  he.tag == `
` && (he.last = ue.length == 0 || ue[0].tag == `
`);
                }
                me.push(he);
              }
              if (ne.length > 0) throw new Error("missing closing tag: " + ne.pop().n);
              return me;
            })(v, 0, [], (M = M || {}).sectionTags || []);
          }, S.cache = {}, S.cacheKey = function(v, k) {
            return [v, !!k.asString, !!k.disableLambda, k.delimiters, !!k.modelGet].join("||");
          }, S.compile = function(v, k) {
            k = k || {};
            var M = S.cacheKey(v, k), Q = this.cache[M];
            if (Q) {
              var ue = Q.partials;
              for (var Be in ue) delete ue[Be].instance;
              return Q;
            }
            return Q = this.generate(this.parse(this.scan(v, k.delimiters), v, k), v, k), this.cache[M] = Q;
          };
        })(W);
      }, function(q, W, D) {
        var S = D(2);
        q.exports = function() {
          var G = new S.Template({ code: function(P, B, c) {
            var s = this;
            return s.b(c = c || ""), s.b('<div class = "category-wrapper">'), s.b(`
` + c), s.b('    <div class = "category-title">'), s.b(`
` + c), s.b("        <span>"), s.b(s.v(s.f("title", P, B, 0))), s.b("</span>"), s.b(`
` + c), s.b("    </div>"), s.b(`
` + c), s.b('    <div class = "category-content"></div>'), s.b(`
` + c), s.b("</div>"), s.fl();
          }, partials: {}, subs: {} }, `<div class = "category-wrapper">
...
class Xr {
  constructor({
    label: V = '<i class="lite-editor-emoji-font lite-editor-emoji-font-smile"></i>',
    group: we,
    categories: q = $r,
    default_footer_message: W = "Please select an emoji from the list above",
    sheets: D = Qr
  }) {
    this.label = V, this.group = we, this.categories = q, this.sheets = D, this.default_footer_message = W, this.action = "extra", this.firstClicked = !1;
  }
  onInit(V, we) {
    const q = document.querySelector(`[data-id="${V.id}"]`), W = q.querySelector('[data-selector="lite-editor"]');
    q.style.position = "relative", this.editable = W, this.editor = V, this.container = q, this.target = we;
  }
  onClick() {
    const { default_footer_message: V, categories: we, container: q, editable: W, target: D, editor: S, sheets: G } = this;
    if (this.firstClicked)
      return;
    this.firstClicked = !0, S.saveSelection();
    const P = new Vr({
      callback: () => {
        S.onInput();
      },
      default_footer_message: V,
      categories: we,
      sheets: G
    });
    P.listenOn(D, q, W), S.restoreSelection(), P.editor.selectLastNode(), P.picker_open = !0, P.openPicker(S.e);
  }
  onRender(V, we) {
    V.data.showSource ? we.setAttribute("disabled", !0) : we.removeAttribute("disabled");
  }
}
export {
  Xr as default
